...
# direct methods
.method private constructor <init>(Landroid/content/Context;Lagb;Laif;Lahf;Lahd;Lapn;Lape;ILaqm;Ljava/util/Map;)V
    .locals 24
    ...
    iget-object v5, v5, Laco;->d:Lapz;

    invoke-virtual {v5, v6}, Lapz;->a(Ladr;)V
    ...
    invoke-direct/range {v4 .. v11}, Lacl;-><init>(Landroid/content/Context;Lahd;Laco;Laqm;Ljava/util/Map;Lagb;I)V
...
.method public static a(Landroid/content/Context;)Lacj;
    ...
    invoke-direct {v5, v0}, Lazb;-><init>(Landroid/content/Context;)V

    invoke-virtual {v5}, Lazb;->a()Ljava/util/List;
    ...
    invoke-direct {v10, v4}, Lapn;-><init>(Lazz;)V
    ...
    iget-object v13, v14, Lack;->l:Laqm;

    const/4 v5, 0x1

    iput-boolean v5, v13, Laqm;->v:Z

    iget-object v14, v14, Lack;->a:Ljava/util/Map;

    move-object/from16 v5, v16

    invoke-direct/range {v4 .. v14}, Lacj;-><init>(Landroid/content/Context;Lagb;Laif;Lahf;Lahd;Lapn;Lape;ILaqm;Ljava/util/Map;)V
...
.method public static b(Landroid/content/Context;)Lact;
    ...
    invoke-virtual {v1, v2}, Lapn;->a(Landroid/support/v4/app/FragmentManager;)Lapq;

    move-result-object v2

    iget-object v1, v2, Lapq;->c:Lact;
    ...
    iget-object v3, v2, Lapq;->a:Lapa;

    iget-object v4, v2, Lapq;->b:Lapo;

    invoke-static {v1, v3, v4, v0}, Lazz;->a(Lacj;Lapi;Lapo;Landroid/content/Context;)Lact;

    move-result-object v0

    iput-object v0, v2, Lapq;->c:Lact;
...
.method final a(Laqy;)Z
    ...
    invoke-virtual {v0, p1}, Lact;->b(Laqy;)Z
