...
.method public constructor <init>(Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;)V
    ...
    iput-object p1, p0, Lcoq;->f:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    new-instance v0, Lcop;

    invoke-direct {v0, p0}, Lcop;-><init>(Lcoq;)V

    iput-object v0, p0, Lcoq;->g:Lcop;

    new-instance v0, Lcor;

    invoke-direct {v0, p0}, Lcor;-><init>(Lcoq;)V

    iput-object v0, p0, Lcoq;->h:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v2, p1, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->c:Lcmh;

    invoke-interface {v2}, Lcmh;->getContext()Landroid/content/Context;
    ...
    iget-object v4, p0, Lcoq;->g:Lcop;

    invoke-direct {v1, v2, v3, v4, v0}, Lcol;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcop;Landroid/animation/TimeInterpolator;)V

    iput-object v1, p0, Lcoq;->d:Lcol;

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcoq;->e:Z

    new-instance v1, Landroid/animation/ValueAnimator;

    invoke-direct {v1}, Landroid/animation/ValueAnimator;-><init>()V

    iput-object v1, p0, Lcoq;->a:Landroid/animation/ValueAnimator;

    iget-object v1, p0, Lcoq;->a:Landroid/animation/ValueAnimator;

    iget-object v2, p0, Lcoq;->h:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object v0, p0, Lcoq;->a:Landroid/animation/ValueAnimator;

    new-instance v1, Lcos;

    invoke-direct {v1, p0}, Lcos;-><init>(Lcoq;)V
...
.method private final b(F)V
    ...
    iget-object v0, p0, Lcoq;->f:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;
    ...
    iget-object v3, p0, Lcoq;->f:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;
...
.method public final a(F)V
    ...
    invoke-virtual {p0, v0}, Lcoq;->a(Z)Z
...
.method public final a(IIZ)V
    ...
    :cond_0
    iput-boolean p3, p0, Lcoq;->e:Z

    iget-object v0, p0, Lcoq;->d:Lcol;

    iget-object v1, p0, Lcoq;->f:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;

    iget v1, v1, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->l:I

    iget-object v2, p0, Lcoq;->f:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;

    iget v2, v2, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->l:I

    sub-int v2, p1, v2

    iget-object v3, v0, Lcol;->d:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v0, Lcol;->b:Lcop;

    iput v1, v2, Lcop;->a:I

    iget-object v0, v0, Lcol;->d:Landroid/animation/ValueAnimator;
...
.method public final a(Lcmq;)V
    ...
    iput-object p1, v0, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->n:Lcmq;
...
.method public final a(Lgyq;)V
    ...
    iput-object p1, v0, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->g:Lgyq;
    ...
    iget-object v2, v0, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->g:Lgyq;

    invoke-interface {v2, v1, v1}, Lgyq;->a(II)V

    iget-object v1, v0, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->g:Lgyq;

    new-instance v2, Lcmt;

    new-instance v3, Lcoj;

    invoke-direct {v3, v0}, Lcoj;-><init>(Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;)V

    invoke-direct {v2, v3}, Lcmt;-><init>(Lcmb;)V

    invoke-interface {v1, v2}, Lgyq;->a(Lcmb;)V
...
.method public final a(Leqd;)Z
    ...
    iget-object v2, v1, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->m:[Lcoz;
    ...
    iget-object v5, v4, Lcoz;->b:Landroid/view/View;
...
.method public final a(Z)Z
    ...
    :cond_1
    iget-object v1, p0, Lcoq;->d:Lcol;

    iget-object v2, v1, Lcol;->c:Landroid/widget/Scroller;

    invoke-virtual {v2, v0}, Landroid/widget/Scroller;->forceFinished(Z)V

    iget-object v1, v1, Lcol;->d:Landroid/animation/ValueAnimator;
...
.method final b(Z)F
    ...
    invoke-virtual {v3}, Leqe;->d()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-interface {v2}, Leqd;->l()Lihc;
...
.method public final b()Z
    ...
    invoke-virtual {p0, v0}, Lcoq;->c(I)Z
...
.method public final b(I)Z
    ...
    iget-object v1, v1, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->g:Lgyq;

    invoke-interface {v1, p1}, Lgyq;->e(I)Leqd;
    ...
    invoke-interface {v1, v0}, Lgyq;->e(I)Leqd;
    ...
    iget-object v7, p0, Lcoq;->f:Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;
    ...
    :cond_4
    invoke-virtual {p0, v2}, Lcoq;->a(Z)Z

    const/16 v0, 0x320

    invoke-virtual {p0, v5, v0, v3}, Lcoq;->a(IIZ)V
...
.method final c(I)Z
    ...
    :cond_0
    invoke-virtual {p0, v1}, Lcoq;->a(Z)Z

    invoke-virtual {v2}, Lcoz;->c()I

    move-result v2

    const/16 v3, 0x320

    invoke-virtual {p0, v2, v3, v0}, Lcoq;->a(IIZ)V
...
.method public final d()V
    ...
    iget-object v2, v2, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->g:Lgyq;

    invoke-interface {v2, v1}, Lgyq;->a(Lckw;)I
    ...
    iget-object v1, v2, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->g:Lgyq;

    invoke-interface {v1, v0}, Lgyq;->f(I)Lckw;

    move-result-object v1

    invoke-interface {v1, v4}, Lckw;->a(I)Ljava/util/List;
    ...
    :cond_3
    invoke-virtual {v2, v0}, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->d(Lckw;)I

    move-result v4

    if-ne v4, v6, :cond_4

    iget-object v4, v2, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->m:[Lcoz;

    invoke-virtual {v2, v0}, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->a(Lckw;)Lcoz;
    ...
    iget-object v5, v2, Lcom/google/android/apps/camera/legacy/app/filmstrip/widget/FilmstripView;->m:[Lcoz;
...
.method public final e()V
    ...
    invoke-direct {p0, v0}, Lcoq;->b(F)V
...
.method public final f()Z
    ...
    iget-object v2, p0, Lcoq;->d:Lcol;

    iget-object v3, v2, Lcol;->c:Landroid/widget/Scroller;
    ...
    iget-object v2, v2, Lcol;->d:Landroid/animation/ValueAnimator;
...
.method public final g()V
    ...
    invoke-direct {p0, v2}, Lcoq;->b(F)V
...
.method public final h()Z
    ...
    iget-object v0, p0, Lcoq;->c:Landroid/animation/AnimatorSet;
...
.method public final i()Z
    ...
    iget-object v0, p0, Lcoq;->b:Landroid/animation/ValueAnimator;
