...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v0}, Lgyl;->setScaleType(Landroid/widget/ImageView$ScaleType;)V

    new-instance v0, Lgym;

    invoke-direct {v0, p0}, Lgym;-><init>(Lgyl;)V

    invoke-virtual {p0, v0}, Lgyl;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lgyl;->d:Lgyn;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lgyl;->d:Lgyn;

    invoke-virtual {v0}, Lgyn;->isCancelled()Z
    ...
    invoke-virtual {v0, v1}, Lgyn;->cancel(Z)Z

    const/16 v0, 0x8

    invoke-virtual {p0, v0}, Lgyl;->setVisibility(I)V
...
.method final b()Ljava/io/InputStream;
    ...
    :try_start_0
    invoke-virtual {p0}, Lgyl;->getContext()Landroid/content/Context;
    ...
    iget-object v2, p0, Lgyl;->e:Landroid/net/Uri;
