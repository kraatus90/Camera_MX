...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lbjy;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lhjr;->a:Landroid/content/Context;

    iput-object p2, p0, Lhjr;->b:Landroid/os/Handler;

    iput-object p3, p0, Lhjr;->c:Lbjy;
...
.method public a(F)V
    ...
    iget-object v1, p0, Lhjr;->i:Lhjf;

    if-eqz v1, :cond_0

    iput v0, p0, Lhjr;->j:F

    iget-object v0, p0, Lhjr;->k:Lcom/google/android/apps/refocus/processing/FocusSettings;

    iget-object v1, p0, Lhjr;->i:Lhjf;

    iget-object v2, p0, Lhjr;->k:Lcom/google/android/apps/refocus/processing/FocusSettings;

    iget v2, v2, Lcom/google/android/apps/refocus/processing/FocusSettings;->focalDistance:F

    iget-object v3, p0, Lhjr;->k:Lcom/google/android/apps/refocus/processing/FocusSettings;

    iget v3, v3, Lcom/google/android/apps/refocus/processing/FocusSettings;->depthOfField:F

    iget v4, p0, Lhjr;->j:F

    invoke-virtual {v1, v2, v3, v4}, Lhjf;->a(FFF)F
...
.method public a(II)V
    ...
    iget-object v2, p0, Lhjr;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    iget-object v2, p0, Lhjr;->e:Landroid/graphics/Bitmap;
    ...
    iget-object v4, p0, Lhjr;->d:Landroid/widget/ImageView;
    ...
    iget-object v5, p0, Lhjr;->e:Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lhjr;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    iget-object v1, p0, Lhjr;->k:Lcom/google/android/apps/refocus/processing/FocusSettings;
...
.method public a(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {p0, p1}, Lhjr;->b(Landroid/graphics/Bitmap;)V

    :cond_0
    iget-object v0, p0, Lhjr;->m:Lcom/google/android/apps/refocus/processing/ProgressListener;
...
.method a(FF)[F
    ...
    iget-object v1, p0, Lhjr;->d:Landroid/widget/ImageView;
...
.method public b(Landroid/graphics/Bitmap;)V
    ...
    iput-object p1, p0, Lhjr;->e:Landroid/graphics/Bitmap;

    iget-object v0, p0, Lhjr;->d:Landroid/widget/ImageView;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lhjr;->d:Landroid/widget/ImageView;

    iget-object v1, p0, Lhjr;->e:Landroid/graphics/Bitmap;
...
.method public b()[F
    ...
    iget-object v0, p0, Lhjr;->e:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v0, v1}, Lhjr;->a(FF)[F
    ...
    iget-object v1, p0, Lhjr;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    iget-object v3, p0, Lhjr;->e:Landroid/graphics/Bitmap;
...
.method c()V
    ...
    :try_start_0
    iget-object v0, p0, Lhjr;->n:Ljava/util/concurrent/CountDownLatch;
...
.method d()V
    ...
    iput-boolean v0, p0, Lhjr;->l:Z

    iget-object v0, p0, Lhjr;->h:Lcom/google/android/apps/refocus/viewer/RGBZViewer$RenderProgress;
    ...
    iget-object v3, p0, Lhjr;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    invoke-direct {v0, p0, v4}, Lcom/google/android/apps/refocus/viewer/RGBZViewer$RenderProgress;-><init>(Lhjr;Lhjl;)V

    iput-object v0, p0, Lhjr;->h:Lcom/google/android/apps/refocus/viewer/RGBZViewer$RenderProgress;

    iget-object v0, p0, Lhjr;->b:Landroid/os/Handler;

    invoke-virtual {v0, v4}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v6, p0, Lhjr;->b:Landroid/os/Handler;

    new-instance v0, Lhjp;

    iget-object v1, p0, Lhjr;->a:Landroid/content/Context;

    iget-object v2, p0, Lhjr;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;

    iget-object v4, p0, Lhjr;->h:Lcom/google/android/apps/refocus/viewer/RGBZViewer$RenderProgress;

    iget-object v5, p0, Lhjr;->g:Landroid/graphics/Bitmap;

    move-object v3, p0

    invoke-direct/range {v0 .. v5}, Lhjp;-><init>(Landroid/content/Context;Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;Lhjr;Lcom/google/android/apps/refocus/processing/ProgressCallback;Landroid/graphics/Bitmap;)V
