...
.method public constructor <init>(Lcom/google/android/libraries/smartburst/filterfw/VideoFrameProvider;)V
    ...
    iput-object v0, p0, Lixz;->a:Ljava/util/Set;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lixz;->b:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lixz;->c:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lixz;->d:Ljava/util/Map;
    ...
    iput-wide v0, p0, Lixz;->e:J

    iput-object p1, p0, Lixz;->f:Lcom/google/android/libraries/smartburst/filterfw/VideoFrameProvider;
...
.method public final addVideoFrameConsumer(Lcom/google/android/libraries/smartburst/filterfw/VideoFrameConsumer;)V
    ...
    :try_start_0
    iget-boolean v0, p0, Lixz;->g:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lixz;->f:Lcom/google/android/libraries/smartburst/filterfw/VideoFrameProvider;
...
.method public final grabVideoFrame(Lcom/google/android/libraries/smartburst/filterfw/FrameImage2D;Lcom/google/android/libraries/smartburst/filterfw/FrameValue;Lcom/google/android/libraries/smartburst/filterfw/geometry/Scaler;)Z
    ...
    :try_start_0
    iget-object v0, p0, Lixz;->b:Ljava/util/Map;
    ...
    iget-object v2, p0, Lixz;->b:Ljava/util/Map;
    ...
    iget-object v0, p0, Lixz;->d:Ljava/util/Map;
...
.method public final onVideoFrameAvailable(Lcom/google/android/libraries/smartburst/filterfw/VideoFrameProvider;J)V
    ...
    :try_start_0
    iget-object v0, p0, Lixz;->a:Ljava/util/Set;
...
.method public final skipVideoFrame()V
    ...
    :try_start_0
    iget-object v0, p0, Lixz;->c:Ljava/util/Map;
    ...
    iget-object v1, p0, Lixz;->c:Ljava/util/Map;
