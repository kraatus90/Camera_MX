...
# direct methods
.method public constructor <init>(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;Ljlo;)V
    .locals 1

    invoke-direct {p0}, Ljks;-><init>()V

    iput-object p2, p0, Ljlp;->a:Ljlo;

    iput-object p1, p0, Ljlp;->b:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;
...
.method public final a(Ljkl;)Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, Ljlp;->b:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;
    ...
    iget-object v5, p0, Ljlp;->b:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;

    sget-object v8, Ljpe;->c:Ljpe;

    invoke-interface {v5, v6, v7, v8}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getFeature(JLjpe;)Lcom/google/android/libraries/smartburst/utils/Feature;
    ...
    iget-object v5, p0, Ljlp;->a:Ljlo;

    iget v6, p0, Ljlp;->c:F

    iget v7, p0, Ljlp;->d:F

    invoke-direct/range {v0 .. v7}, Ljlq;-><init>([F[F[JLjava/util/List;Ljlo;FF)V
    ...
    iget-object v3, v0, Ljlq;->b:[J

    iget-object v5, v0, Ljlq;->b:[J
    ...
    invoke-virtual {v0, v2, v7}, Ljlq;->a(II)D
    ...
    invoke-virtual {v0, v8, v7}, Ljlq;->a(II)D
    ...
    iget-object v10, v0, Ljlq;->c:Ljava/util/List;

    iget-object v0, v0, Ljlq;->b:[J
    ...
    invoke-direct/range {v0 .. v5}, Ljkl;-><init>(Ljava/util/Collection;JJ)V
