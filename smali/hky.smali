...
# static fields
.field public static final a:Lhky;
...
.method public static a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, p1, v1}, Lhla;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v1

    new-instance v2, Lhmt;

    invoke-direct {v2, v1, p0, p2}, Lhmt;-><init>(Landroid/content/Intent;Landroid/app/Activity;I)V
    ...
    :cond_2
    invoke-static {p0, p1}, Lhms;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1}, Lhms;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p0, p1}, Lhms;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Lhuu;)Lhut;
    .locals 2
    ...
    invoke-direct {v0, p1}, Lhut;-><init>(Lhuu;)V

    invoke-virtual {p0, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    iput-object p0, v0, Lhut;->a:Landroid/content/Context;

    const-string v1, "com.google.android.gms"

    invoke-static {p0, v1}, Lhlc;->a(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p1}, Lhuu;->a()V
...
.method public final a(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {v0, p0, p1}, Lhkz;-><init>(Lhky;Landroid/content/Context;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lhms;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, p2}, Lhms;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1}, Lhmr;->a(Landroid/content/Context;)Z

    move-result v3

    if-eqz v3, :cond_3

    invoke-static {v6}, Lhmr;->a(Z)V
    ...
    sget-object v1, Lhlc;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final b(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    invoke-static {p1, p2, p3, p4}, Lhky;->a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {v0, v4}, Lhmr;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, v3, Lhle;->mDialog:Landroid/app/Dialog;

    if-eqz p4, :cond_1

    iput-object p4, v3, Lhle;->a:Landroid/content/DialogInterface$OnCancelListener;
    ...
    iput-object v0, v3, Lhkx;->a:Landroid/app/Dialog;

    if-eqz p4, :cond_3

    iput-object p4, v3, Lhkx;->b:Landroid/content/DialogInterface$OnCancelListener;
