...
.method public final synthetic a(Ljava/io/DataInputStream;)Ljava/lang/Object;
    ...
    invoke-static/range {p1 .. p1}, Ljbj;->a(Ljava/io/DataInputStream;)Landroid/graphics/PointF;
...
.method public final a(Ljava/lang/Object;Ljava/io/DataOutputStream;)V
    ...
    invoke-static {v0, p2}, Ljbj;->a(Landroid/graphics/PointF;Ljava/io/DataOutputStream;)V

    invoke-virtual {v1}, Lcom/google/android/vision/face/Face;->getWidth()F

    move-result v0

    invoke-virtual {p2, v0}, Ljava/io/DataOutputStream;->writeFloat(F)V

    invoke-virtual {v1}, Lcom/google/android/vision/face/Face;->getHeight()F

    move-result v0

    invoke-virtual {p2, v0}, Ljava/io/DataOutputStream;->writeFloat(F)V

    invoke-virtual {v1}, Lcom/google/android/vision/face/Face;->getVisualizationPolygon()Ljava/util/List;
    ...
    :cond_2
    invoke-virtual {v1}, Lcom/google/android/vision/face/Face;->getYawDegrees()F

    move-result v0

    invoke-virtual {p2, v0}, Ljava/io/DataOutputStream;->writeFloat(F)V

    invoke-virtual {v1}, Lcom/google/android/vision/face/Face;->getRollDegrees()F

    move-result v0

    invoke-virtual {p2, v0}, Ljava/io/DataOutputStream;->writeFloat(F)V

    invoke-virtual {v1}, Lcom/google/android/vision/face/Face;->getConfidence()F

    move-result v0

    invoke-virtual {p2, v0}, Ljava/io/DataOutputStream;->writeFloat(F)V

    invoke-virtual {v1}, Lcom/google/android/vision/face/Face;->getLandmarks()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/google/android/vision/face/Landmark;->getPosition()Landroid/graphics/PointF;

    move-result-object v4

    invoke-static {v4, p2}, Ljbj;->a(Landroid/graphics/PointF;Ljava/io/DataOutputStream;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/vision/face/Face;->getFrameNumber()I
    ...
    invoke-virtual {v1}, Lcom/google/android/vision/face/Face;->getIsSmilingScore()F
