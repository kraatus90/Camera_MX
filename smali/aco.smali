...
.field public final d:Lapz;

.field private final e:Lakl;

.field private final f:Laqc;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Laco;->h:Laqb;

    new-instance v0, Laqa;

    invoke-direct {v0}, Laqa;-><init>()V

    iput-object v0, p0, Laco;->i:Laqa;

    invoke-static {}, Larz;->a()Lgw;
    ...
    iput-object v0, p0, Laco;->a:Lapx;

    new-instance v0, Laqc;

    invoke-direct {v0}, Laqc;-><init>()V

    iput-object v0, p0, Laco;->f:Laqc;

    new-instance v0, Laqe;

    invoke-direct {v0}, Laqe;-><init>()V

    iput-object v0, p0, Laco;->b:Laqe;
    ...
    iget-object v0, p0, Laco;->f:Laqc;

    invoke-virtual {v0, v1}, Laqc;->a(Ljava/util/List;)V
...
.method public final a(Ljava/lang/Class;Ladp;)Laco;
    ...
    iget-object v0, p0, Laco;->a:Lapx;

    invoke-virtual {v0, p1, p2}, Lapx;->a(Ljava/lang/Class;Ladp;)V
...
.method public final a(Ljava/lang/Class;Laea;)Laco;
    ...
    iget-object v0, p0, Laco;->b:Laqe;

    invoke-virtual {v0, p1, p2}, Laqe;->a(Ljava/lang/Class;Laea;)V
...
.method public final a(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;Ladz;)Laco;
    ...
    invoke-virtual {v0, p1, p4, p2, p3}, Laqc;->a(Ljava/lang/String;Ladz;Ljava/lang/Class;Ljava/lang/Class;)V
...
.method public final a(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)Lagt;
    ...
    iget-object v0, p0, Laco;->i:Laqa;

    invoke-virtual {v0, p1, p2, p3}, Laqa;->a(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)Lagt;

    move-result-object v0

    sget-object v1, Laqa;->a:Lagt;
    ...
    invoke-virtual {v0, p1, p2}, Laqc;->b(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1, v2}, Laqc;->a(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    :goto_2
    iget-object v1, p0, Laco;->i:Laqa;

    iget-object v2, v1, Laqa;->b:Lgh;

    monitor-enter v2

    :try_start_0
    iget-object v3, v1, Laqa;->b:Lgh;

    new-instance v4, Larw;

    invoke-direct {v4, p1, p2, p3}, Larw;-><init>(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)V
...
.method public final a()Ljava/util/List;
    ...
    iget-object v0, p0, Laco;->d:Lapz;

    invoke-virtual {v0}, Lapz;->a()Ljava/util/List;
...
.method public final b(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    iget-object v0, p0, Laco;->h:Laqb;

    invoke-virtual {v0, p1, p2}, Laqb;->a(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    iget-object v3, p0, Laco;->f:Laqc;

    invoke-virtual {v3, v0, p2}, Laqc;->b(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    iget-object v3, v0, Laqb;->a:Lgh;

    monitor-enter v3

    :try_start_0
    iget-object v0, v0, Laqb;->a:Lgh;

    new-instance v4, Larw;

    invoke-direct {v4, p1, p2}, Larw;-><init>(Ljava/lang/Class;Ljava/lang/Class;)V
