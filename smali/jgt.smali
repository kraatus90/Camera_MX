...
.method public static a(Ljgs;Ljava/lang/String;Landroid/graphics/Bitmap;)Ljgv;
    .locals 7
    ...
    invoke-static/range {v0 .. v6}, Ljgt;->a(Ljgs;Ljava/lang/String;Landroid/graphics/Bitmap;IILandroid/graphics/Matrix;Z)Ljgv;
...
.method public static a(Ljgs;Ljava/lang/String;Landroid/graphics/Bitmap;II)Ljgv;
    .locals 7
    ...
    :try_start_0
    sget-object v5, Ljgt;->a:Landroid/graphics/Matrix;

    const/4 v0, 0x0

    sput-object v0, Ljgt;->a:Landroid/graphics/Matrix;
    ...
    :try_start_1
    sget-object v2, Ljgt;->a:Landroid/graphics/Matrix;

    if-nez v2, :cond_1

    sput-object v5, Ljgt;->a:Landroid/graphics/Matrix;
...
.method private static a(Ljgs;Ljava/lang/String;Landroid/graphics/Bitmap;IILandroid/graphics/Matrix;Z)Ljgv;
    .locals 9
    ...
    :cond_5
    invoke-interface {p0, p1, p3, p4, v2}, Ljgs;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Ljgv;
    ...
    :goto_3
    invoke-interface {p0, p1, v7, v8, v0}, Ljgs;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Ljgv;
...
.method public static a(Ljgs;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Ljgv;
    .locals 6
    ...
    invoke-interface {p0, v0, v1}, Ljgs;->a(Ljava/lang/String;Landroid/graphics/Bitmap;)Ljgv;
    ...
    invoke-static {v1, v0}, Ljgt;->a(Landroid/graphics/Bitmap;Ljgv;)V

    invoke-static {v0, v2, v3}, Ljgt;->a(Ljgv;II)V

    invoke-static {v0, v4}, Ljgt;->a(Ljgv;Landroid/graphics/Bitmap$Config;)V
    ...
    :cond_3
    invoke-interface {p0, v0, v2, v3, v4}, Ljgs;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Ljgv;
...
.method public static a(Ljgs;Ljava/lang/String;Landroid/graphics/Rect;)Ljgv;
    .locals 5
    ...
    invoke-interface {p0, v0, v3, v4, v2}, Ljgs;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Ljgv;
    ...
    invoke-static {v1, v3}, Ljgt;->a(Landroid/graphics/Bitmap;Ljgv;)V
    ...
    invoke-static {v3, v0, v1}, Ljgt;->a(Ljgv;II)V

    invoke-static {v3, v2}, Ljgt;->a(Ljgv;Landroid/graphics/Bitmap$Config;)V
    :try_end_0
...
.method public static a(Ljgs;Ljava/lang/String;Ljava/nio/ByteBuffer;II)Ljgv;
    .locals 2

    sget-object v0, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-interface {p0, p1, p3, p4, v0}, Ljgs;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Ljgv;
...
.method public static a(Ljgs;Ljava/lang/String;Ljgv;II)Ljgv;
    .locals 1

    invoke-interface {p2}, Ljgv;->e()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/graphics/Bitmap;

    invoke-static {p0, p1, v0, p3, p4}, Ljgt;->a(Ljgs;Ljava/lang/String;Landroid/graphics/Bitmap;II)Ljgv;
...
.method public static a(Ljgs;Ljpt;Ljava/lang/String;)Ljgv;
    .locals 4
    ...
    invoke-interface {p0, p2, v0, v1, v2}, Ljgs;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Ljgv;
...
.method private static a(Landroid/graphics/Bitmap;Ljgv;)V
    .locals 5
...
.method private static a(Ljgv;II)V
    .locals 5

    invoke-interface {p0}, Ljgv;->e()Ljava/lang/Object;
...
.method private static a(Ljgv;Landroid/graphics/Bitmap$Config;)V
    .locals 5
