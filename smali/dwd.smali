...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldwd;->a:Ljava/lang/String;
    ...
    sput-object v0, Ldwd;->j:[Labj;

    new-instance v0, Ldwe;

    invoke-direct {v0}, Ldwe;-><init>()V

    sput-object v0, Ldwd;->m:Ljava/util/Comparator;

    return-void
.end method

.method public constructor <init>(Lbyy;Landroid/os/Handler;Laao;I)V
    .locals 30
    ...
    iput-object v4, v0, Ldwd;->b:Laao;

    const/4 v4, 0x0

    move-object/from16 v0, p0

    iput-object v4, v0, Ldwd;->c:Labo;

    const/4 v4, 0x0

    move-object/from16 v0, p0

    iput-boolean v4, v0, Ldwd;->d:Z

    const/4 v4, 0x0

    move-object/from16 v0, p0

    iput-object v4, v0, Ldwd;->e:Ldwg;

    const/4 v4, 0x0

    move-object/from16 v0, p0

    iput-object v4, v0, Ldwd;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    move-object/from16 v0, p1

    move-object/from16 v1, p0

    iput-object v0, v1, Ldwd;->g:Lbyy;

    invoke-interface/range {p1 .. p1}, Lbyy;->a()Landroid/content/Context;

    move-object/from16 v0, p2

    move-object/from16 v1, p0

    iput-object v0, v1, Ldwd;->h:Landroid/os/Handler;

    move-object/from16 v0, p3

    move-object/from16 v1, p0

    iput-object v0, v1, Ldwd;->b:Laao;
    ...
    iput-object v4, v0, Ldwd;->l:Labg;

    move-object/from16 v0, p0

    iget-object v4, v0, Ldwd;->b:Laao;

    if-eqz v4, :cond_11

    sget-object v4, Ldwd;->a:Ljava/lang/String;
    ...
    iget-object v4, v0, Ldwd;->l:Labg;

    move-object/from16 v0, p0

    iget-object v14, v0, Ldwd;->f:Labv;
    ...
    sget-object v5, Ldwd;->a:Ljava/lang/String;

    const-string v6, "preview formats:\n"

    invoke-static {v15}, Ldwd;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {v5, v4}, Lbki;->a(Ljava/lang/String;Ljava/lang/String;)V

    sget-object v5, Ldwd;->a:Ljava/lang/String;

    const-string v6, "picture formats:\n"

    invoke-static {v8}, Ldwd;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    sget-object v4, Ldwd;->m:Ljava/util/Comparator;
    ...
    new-instance v16, Lhhy;

    new-instance v4, Lhhz;

    move/from16 v0, p4

    invoke-direct {v4, v0}, Lhhz;-><init>(I)V

    move-object/from16 v0, v16

    invoke-direct {v0, v4}, Lhhy;-><init>(Lhhz;)V

    move-object/from16 v0, v16

    iget-object v4, v0, Lhhy;->a:Lhhz;

    iget-wide v4, v4, Lhhz;->b:D
    ...
    iget-object v0, v0, Lhhy;->a:Lhhz;

    move-object/from16 v21, v0

    move-object/from16 v0, v21

    iget-wide v0, v0, Lhhz;->e:D
    ...
    invoke-static {v4, v5}, Lbki;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_10
    invoke-virtual/range {p0 .. p0}, Ldwd;->d()V
    ...
    iput-object v4, v0, Ldwd;->i:Ljava/lang/Object;
    ...
    invoke-static {v5, v4}, Lbki;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a(Laba;)V
    ...
    iget-object v1, p0, Ldwd;->i:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v0, p0, Ldwd;->d:Z
    ...
    :cond_0
    iget-object v0, p0, Ldwd;->e:Ldwg;

    if-eqz v0, :cond_3

    iget-object v0, p0, Ldwd;->f:Labv;
    ...
    iput-object v0, p0, Ldwd;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    iget-object v0, p0, Ldwd;->b:Laao;

    iget-object v2, p0, Ldwd;->h:Landroid/os/Handler;
...
.method public final a(Labv;)V
    ...
    iput-object p1, p0, Ldwd;->f:Labv;

    iget-object v0, p0, Ldwd;->b:Laao;

    iget-object v1, p0, Ldwd;->f:Labv;
...
.method public final a(Landroid/graphics/SurfaceTexture;Laba;)V
    ...
    :cond_0
    sget-object v0, Ldwd;->a:Ljava/lang/String;
    ...
    invoke-virtual {p0, p2}, Ldwd;->a(Laba;)V
...
.method public final a([BLaao;)V
    ...
    :cond_1
    iget-object v0, p0, Ldwd;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    invoke-virtual {v0, p1}, Lcom/google/android/apps/refocus/image/ColorImage;->setBuffer([B)V

    iget-object v0, p0, Ldwd;->e:Ldwg;

    iget-object v1, p0, Ldwd;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v2

    invoke-interface {v0, v1, v2, v3}, Ldwg;->a(Lcom/google/android/apps/refocus/image/ColorImage;J)V
...
.method public final c()V
    ...
    :cond_0
    invoke-virtual {p0}, Ldwd;->b()V

    const/4 v0, 0x0

    iput-object v0, p0, Ldwd;->b:Laao;
