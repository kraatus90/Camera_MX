...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldyu;->k:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Lbyy;Lggn;)V
    .locals 2
    ...
    iput-object v0, p0, Ldyu;->a:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Landroid/os/Handler;

    invoke-direct {v0}, Landroid/os/Handler;-><init>()V

    iput-object v0, p0, Ldyu;->m:Landroid/os/Handler;
    ...
    iput-object v0, p0, Ldyu;->i:Ljava/lang/Boolean;

    invoke-static {v1}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Ldyu;->j:Ljava/lang/Boolean;

    new-instance v0, Ldyv;

    invoke-direct {v0, p0}, Ldyv;-><init>(Ldyu;)V

    iput-object v0, p0, Ldyu;->r:Ljava/lang/Runnable;
...
.method private static a(Landroid/graphics/Bitmap;Lwk;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v0}, Ldyu;->a(Lwk;Ljava/lang/String;)I
    ...
    invoke-static {p1, v3}, Ldyu;->a(Lwk;Ljava/lang/String;)I

    move-result v3

    const-string v4, "CroppedAreaLeftPixels"

    invoke-static {p1, v4}, Ldyu;->a(Lwk;Ljava/lang/String;)I

    move-result v4

    const-string v5, "CroppedAreaTopPixels"

    invoke-static {p1, v5}, Ldyu;->a(Lwk;Ljava/lang/String;)I
    ...
    invoke-static {v0, v3}, Ldyu;->a(II)Landroid/graphics/Bitmap;
...
.method private final a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1}, Ldyu;->a(Landroid/net/Uri;)Ljava/io/InputStream;

    move-result-object v2

    if-nez v2, :cond_0

    sget-object v0, Ldyu;->k:Ljava/lang/String;

    const-string v1, "Could not create input stream for image."

    invoke-static {v0, v1}, Lbki;->b(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0}, Ldyu;->dismiss()V
    ...
    invoke-static {v2}, Lepy;->a(Ljava/io/InputStream;)Lwk;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    move-result-object v3

    invoke-static {v2}, Ldyu;->a(Ljava/io/InputStream;)V

    if-eqz v3, :cond_2

    if-eqz p2, :cond_1

    iget-object v0, p0, Ldyu;->l:Lbyy;

    invoke-interface {v0}, Lbyy;->A()Landroid/view/WindowManager;
    ...
    :goto_0
    invoke-static {v1, v3, v0}, Ldyu;->a(Landroid/graphics/Bitmap;Lwk;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1}, Ldyu;->a(Ljava/io/InputStream;)V
...
.method static synthetic a(Ldyu;)Lggn;
    .locals 1

    iget-object v0, p0, Ldyu;->n:Lggn;
...
.method private final a(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    invoke-interface {v0}, Lbyy;->y()Landroid/content/ContentResolver;
    ...
    sget-object v1, Ldyu;->k:Ljava/lang/String;
...
.method private static a([B)[B
    ...
    sget-object v2, Ldyu;->k:Ljava/lang/String;
...
.method final a()Ldzc;
    ...
    iget-object v0, p0, Ldyu;->a:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    iget-object v0, p0, Ldyu;->h:Landroid/graphics/Bitmap;

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->recycle()V

    const/4 v0, 0x0

    iput-object v0, p0, Ldyu;->h:Landroid/graphics/Bitmap;

    iget-object v0, p0, Ldyu;->g:Landroid/graphics/Bitmap;

    invoke-virtual {v0}, Landroid/graphics/Bitmap;->recycle()V

    const/4 v0, 0x0

    iput-object v0, p0, Ldyu;->g:Landroid/graphics/Bitmap;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v0, p0, Ldyu;->o:Landroid/net/Uri;

    const/4 v1, 0x0

    invoke-direct {p0, v0, v1}, Ldyu;->a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v1}, Ldyu;->a(II)Landroid/graphics/Bitmap;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Ldyu;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {v2, v0, v1}, Ldzc;-><init>([BI)V
    ...
    iget-object v1, p0, Ldyu;->a:Ljava/util/concurrent/locks/Lock;
...
.method final a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    iget-object v4, v0, Ldze;->c:Lxv;

    iget-object v5, v0, Ldze;->b:Landroid/support/v8/renderscript/RenderScript;
    ...
    iget-object v1, v0, Ldze;->c:Lxv;

    invoke-virtual {v1, v3}, Lxv;->a(F)V

    iget-object v1, v0, Ldze;->b:Landroid/support/v8/renderscript/RenderScript;
    ...
    sget-object v0, Ldze;->a:Ljava/lang/String;
...
.method final b()V
    ...
    iget-object v0, p0, Ldyu;->m:Landroid/os/Handler;

    iget-object v1, p0, Ldyu;->r:Ljava/lang/Runnable;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0, v1}, Ldyu;->setStyle(II)V

    new-instance v0, Ldze;

    invoke-virtual {p0}, Ldyu;->getActivity()Landroid/app/Activity;
    ...
    invoke-direct {v0, v1}, Ldze;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Ldyu;->q:Ldze;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p0}, Ldyu;->getDialog()Landroid/app/Dialog;
    ...
    iput-object v0, p0, Ldyu;->b:Lcom/google/android/apps/camera/legacy/app/tinyplanet/TinyPlanetPreview;

    iget-object v0, p0, Ldyu;->b:Lcom/google/android/apps/camera/legacy/app/tinyplanet/TinyPlanetPreview;

    iput-object p0, v0, Lcom/google/android/apps/camera/legacy/app/tinyplanet/TinyPlanetPreview;->c:Ldzd;
    ...
    invoke-direct {v2, p0}, Ldyx;-><init>(Ldyu;)V
    ...
    invoke-direct {v2, p0}, Ldyy;-><init>(Ldyu;)V
    ...
    invoke-direct {v2, p0}, Ldyz;-><init>(Ldyu;)V

    invoke-virtual {v0, v2}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p0}, Ldyu;->getArguments()Landroid/os/Bundle;
    ...
    iput-object v0, p0, Ldyu;->o:Landroid/net/Uri;

    iget-object v0, p0, Ldyu;->o:Landroid/net/Uri;

    invoke-direct {p0, v0, v3}, Ldyu;->a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
