...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Leim;->a:Ljava/util/concurrent/ArrayBlockingQueue;

    iput-boolean v2, p0, Leim;->b:Z

    const/4 v0, 0x0

    iput-object v0, p0, Leim;->d:Lekq;

    invoke-static {v2}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Leim;->e:Ljava/lang/Boolean;
...
.method public final declared-synchronized a(Lekq;)V
    ...
    :try_start_0
    invoke-virtual {p0}, Leim;->isInterrupted()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Leim;->isAlive()Z
...
.method public final interrupt()V
    ...
    iget-object v0, p0, Leim;->a:Ljava/util/concurrent/ArrayBlockingQueue;
...
.method public final run()V
    ...
    :goto_2
    iput-boolean v3, p0, Leim;->b:Z

    if-eqz v0, :cond_0

    :cond_2
    sget-object v0, Leim;->c:Ljava/lang/String;

    const-string v1, "Incremental aligner shutting down. Firing callback ..."

    invoke-static {v0, v1}, Lbki;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Leim;->d:Lekq;
    ...
    :cond_4
    iget-object v6, p0, Leim;->e:Ljava/lang/Boolean;
