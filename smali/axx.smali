...
.method public constructor <init>(Layc;Lfkv;Lffz;Lkeh;Laxn;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Laxx;->b:Layc;

    iput-object p2, p0, Laxx;->c:Lfkv;

    iput-object p3, p0, Laxx;->d:Lffz;

    iput-object p4, p0, Laxx;->e:Lkeh;

    iput-object p5, p0, Laxx;->f:Laxn;
...
.method public final a()V
    ...
    invoke-virtual {v1, v3}, Lfhi;->a(Lfgs;)Lfhi;
    ...
    invoke-interface {v4, v0, v1}, Lfga;->a(Ljava/util/List;Lfhp;)V

    invoke-interface {v4}, Lfga;->close()V
    ...
    iget-object v5, p0, Laxx;->b:Layc;

    new-instance v6, Lgay;

    iget-object v1, p0, Laxx;->f:Laxn;

    invoke-virtual {v1}, Laxn;->b()Lick;
    ...
    invoke-direct {v6, v0, v1, v7}, Lgay;-><init>(Link;Ligz;Lkeh;)V

    invoke-interface {v5, v6}, Layc;->a(Lgay;)V
    :try_end_2
    ...
    :try_start_3
    invoke-static {v0, v4}, Laxx;->a(Ljava/lang/Throwable;Lfga;)V
    :try_end_3
    ...
    :try_start_4
    invoke-static {v0, v3}, Laxx;->a(Ljava/lang/Throwable;Lfjf;)V
    :try_end_4
    .catch Ljava/lang/InterruptedException; {:try_start_4 .. :try_end_4} :catch_2
    .catch Lijd; {:try_start_4 .. :try_end_4} :catch_3
    ...
    :try_start_6
    invoke-static {v1, v4}, Laxx;->a(Ljava/lang/Throwable;Lfga;)V
    ...
    :goto_2
    :try_start_8
    invoke-static {v2, v3}, Laxx;->a(Ljava/lang/Throwable;Lfjf;)V

    throw v0
    :try_end_8
    .catch Ljava/lang/InterruptedException; {:try_start_8 .. :try_end_8} :catch_2
    .catch Lijd; {:try_start_8 .. :try_end_8} :catch_3

    :catch_2
    move-exception v0

    :goto_3
    sget-object v1, Laxx;->a:Ljava/lang/String;
