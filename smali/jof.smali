...
# direct methods
.method public constructor <init>(Ljoc;Ljava/util/List;)V
    .locals 1
    ...
    iput-object v0, p0, Ljof;->b:Ljava/util/List;
...
.method public final a(Ljava/io/File;)J
    ...
    :try_start_1
    iget-object v0, p0, Ljof;->b:Ljava/util/List;

    iget-object v2, p0, Ljof;->a:Ljoc;

    invoke-interface {v2, p1}, Ljoc;->b(Ljava/io/File;)I
    ...
    invoke-virtual {v1}, Ljoe;->getMessage()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Ljoe;->getMessage()Ljava/lang/String;
    ...
    invoke-direct {v2, v0}, Ljoe;-><init>(Ljava/lang/String;)V
