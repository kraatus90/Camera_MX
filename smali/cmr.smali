...
.method public static a(Ljava/util/List;Lckw;)Lcms;
    .locals 8
    ...
    sget-object v0, Lcmr;->a:Ljava/lang/String;
    ...
    invoke-interface {v0}, Lckw;->a()Lckw;
    ...
    invoke-direct {v0, v1, v2}, Lcms;-><init>(Ljava/util/List;Ljava/util/List;)V

    :goto_5
    return-object v0

    :cond_8
    invoke-interface {v3}, Lckw;->b()Lckw;

    move-result-object v0

    invoke-interface {v3}, Lckw;->a()Lckw;
    ...
    :goto_6
    invoke-interface {v0, v4}, Lckw;->a(I)Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Lcms;-><init>(Ljava/util/List;Ljava/util/List;)V
