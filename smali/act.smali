...
# static fields
.field private static final f:Laqm;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Laqm;->a(Ljava/lang/Class;)Laqm;

    move-result-object v0

    iput-boolean v1, v0, Laqm;->v:Z

    sput-object v0, Lact;->f:Laqm;
    ...
    invoke-static {v0}, Laqm;->a(Lafv;)Laqm;
...
.method public constructor <init>(Lacj;Lapi;Lapo;Landroid/content/Context;)V
    .locals 6

    new-instance v4, Lapp;

    invoke-direct {v4}, Lapp;-><init>()V
    ...
    invoke-direct/range {v0 .. v5}, Lact;-><init>(Lacj;Lapi;Lapo;Lapp;Landroid/content/Context;)V

    return-void
.end method

.method private constructor <init>(Lacj;Lapi;Lapo;Lapp;Landroid/content/Context;)V
    .locals 5
    ...
    iput-object p3, p0, Lact;->h:Lapo;

    iput-object p4, p0, Lact;->c:Lapp;
    ...
    invoke-direct {v3, p4}, Lapd;-><init>(Lapp;)V
...
.method public final a()V
    ...
    iget-object v1, p0, Lact;->c:Lapp;

    const/4 v0, 0x0

    iput-boolean v0, v1, Lapp;->c:Z
    ...
    :cond_1
    iget-object v0, v1, Lapp;->b:Ljava/util/List;
...
.method public final a(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v0}, Lact;->a(Laqy;)V
...
.method public final a(Laqy;)V
    ...
    :cond_1
    invoke-static {}, Larx;->b()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1}, Lact;->b(Laqy;)Z
    ...
    invoke-virtual {v0, p1}, Lacj;->a(Laqy;)Z
    ...
    invoke-direct {v1, p0, p1}, Lacv;-><init>(Lact;Laqy;)V
...
.method final b(Laqy;)Z
    ...
    :cond_0
    iget-object v2, p0, Lact;->c:Lapp;

    invoke-virtual {v2, v1, v0}, Lapp;->a(Laqh;Z)Z

    move-result v1

    if-eqz v1, :cond_1

    iget-object v1, p0, Lact;->d:Laps;

    iget-object v1, v1, Laps;->a:Ljava/util/Set;
...
.method public final d()V
    ...
    iget-object v0, v0, Laps;->a:Ljava/util/Set;
    ...
    invoke-virtual {v1, v0, v3}, Lapp;->a(Laqh;Z)Z
