...
.method private final b(Ladu;)Ljava/lang/String;
    ...
    invoke-static {v1}, Larx;->a([B)Ljava/lang/String;
    :try_end_0
...
.method public final a(Ladu;)Ljava/lang/String;
    ...
    iget-object v1, p0, Laik;->a:Laru;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Laik;->a:Laru;
    ...
    :try_start_1
    iget-object v2, p0, Laik;->a:Laru;

    invoke-virtual {v2, p1, v0}, Laru;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
