...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgbv;->b:Ljava/lang/String;

    return-void
.end method

.method constructor <init>(Lgay;Ljava/util/concurrent/Executor;Lgax;ILfzv;Lihc;ILihs;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lgbw;-><init>(Lgay;Ljava/util/concurrent/Executor;Lgax;ILfzv;)V

    iput-object p6, p0, Lgbv;->a:Lihc;

    iput p7, p0, Lgbv;->i:I

    iput-object p8, p0, Lgbv;->j:Lihs;
...
.method protected static a(Lgay;)Lgby;
    .locals 4

    new-instance v0, Lgby;

    iget-object v1, p0, Lgay;->c:Ligz;

    iget-object v2, p0, Lgay;->b:Link;

    invoke-interface {v2}, Link;->c()I

    move-result v2

    iget-object v3, p0, Lgay;->b:Link;

    invoke-interface {v3}, Link;->d()I

    move-result v3

    invoke-direct {v0, v1, v2, v3}, Lgby;-><init>(Ligz;II)V

    return-object v0
.end method

.method private final a(Link;Landroid/graphics/Rect;IZ)[I
    .locals 33

    invoke-static/range {p1 .. p2}, Lgbv;->a(Link;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v4, v2}, Lgbv;->a(II)I
    ...
    invoke-virtual {v0, v3}, Lgbv;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Lgbv;->a(Ljava/lang/String;)V
    ...
    invoke-static/range {v1 .. v8}, Lgbv;->a(IIIIIIII)I
    ...
    invoke-static/range {v9 .. v16}, Lgbv;->a(IIIIIIII)I
    ...
    invoke-static/range {v15 .. v22}, Lgbv;->a(IIIIIIII)I
    ...
    invoke-virtual {v0, v1}, Lgbv;->a(Ljava/lang/String;)V
...
# virtual methods
.method protected final a(Lgay;I)Lgby;
    .locals 4
    ...
    invoke-static {v0, v1}, Lgbv;->a(Link;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    iget-object v3, p1, Lgay;->c:Ligz;

    invoke-direct {v2, v3, v1, v0}, Lgby;-><init>(Ligz;II)V
    ...
    invoke-static {v1, v0}, Lgbv;->a(II)I
...
.method public final a(Lgby;[II)V
    .locals 4

    new-instance v0, Lgbz;

    iget-wide v2, p0, Lgbv;->e:J

    invoke-direct {v0, v2, v3, p1, p3}, Lgbz;-><init>(JLgby;I)V

    iget-object v1, p0, Lgbv;->c:Lgax;
    ...
    invoke-direct {v2, p2}, Lgca;-><init>([I)V

    invoke-interface {v1, v0, v2}, Lgap;->a(Lgbz;Lgca;)V
...
.method public a(Ljava/lang/String;)V
    ...
    sget-object v0, Lgbv;->b:Ljava/lang/String;
...
.method protected final a(Link;Landroid/graphics/Rect;I)[I
    .locals 42
    ...
    invoke-virtual {v0, v4}, Lgbv;->a(Ljava/lang/String;)V
    ...
    invoke-static {v4, v5}, Lgbv;->a(II)I
    ...
    invoke-virtual {v0, v5}, Lgbv;->a(Ljava/lang/String;)V
    ...
    invoke-static {v5, v4}, Lgbv;->a(II)I
    ...
    invoke-static {v7, v6}, Lgbv;->a(II)I
    ...
    invoke-interface {v5}, Linl;->c()Ljava/nio/ByteBuffer;
    ...
    invoke-static/range {v4 .. v11}, Lgbv;->a(IIIIIIII)I
    ...
    invoke-static/range {v12 .. v19}, Lgbv;->a(IIIIIIII)I
    ...
    invoke-static/range {v18 .. v25}, Lgbv;->a(IIIIIIII)I
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lgbv;->a(Link;Landroid/graphics/Rect;IZ)[I
...
.method public run()V
    ...
    iget-object v0, p0, Lgbv;->j:Lihs;

    sget-object v1, Lgbv;->b:Ljava/lang/String;

    invoke-interface {v0, v1}, Lihs;->a(Ljava/lang/String;)V

    iget-object v0, p0, Lgbv;->g:Lgay;
    ...
    iget-object v3, v0, Lgay;->f:Landroid/graphics/Rect;

    invoke-static {v1, v3}, Lgbv;->a(Link;Landroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v3

    invoke-static {v0}, Lgbv;->a(Lgay;)Lgby;
    ...
    invoke-direct {v4, v1, v5}, Lihc;-><init>(II)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v0, v1}, Lgbv;->a(Lgay;I)Lgby;

    move-result-object v2

    :try_start_0
    iget-wide v4, p0, Lgbv;->e:J

    sget v6, Lep;->aX:I

    invoke-virtual {p0, v4, v5, v2, v6}, Lgbv;->a(JLgby;I)V
    ...
    invoke-virtual {p0, v4}, Lgbv;->a(Ljava/lang/String;)V

    iget-object v4, v0, Lgay;->b:Link;

    invoke-virtual {p0, v4, v3, v1}, Lgbv;->a(Link;Landroid/graphics/Rect;I)[I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    move-result-object v1

    iget-object v3, p0, Lgbv;->c:Lgax;

    iget-object v0, v0, Lgay;->b:Link;

    iget-object v4, p0, Lgbv;->d:Ljava/util/concurrent/Executor;

    invoke-interface {v3, v0, v4}, Lgax;->a(Link;Ljava/util/concurrent/Executor;)V

    sget v0, Lep;->aX:I

    invoke-virtual {p0, v2, v1, v0}, Lgbv;->a(Lgby;[II)V
    ...
    invoke-static {v4, v1}, Lgbo;->a(II)Z
    ...
    invoke-static {v4, v1}, Lgbo;->a(Lihc;Lihc;)I
    ...
    iget-object v2, p0, Lgbv;->c:Lgax;

    iget-object v0, v0, Lgay;->b:Link;

    iget-object v3, p0, Lgbv;->d:Ljava/util/concurrent/Executor;
