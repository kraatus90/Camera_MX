...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v4}, Lhjs;->a([II)Z

    move-result v0

    sput-boolean v0, Lhju;->u:Z

    invoke-static {v2}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    invoke-static {v3}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    sget-boolean v0, Lhju;->u:Z
    ...
    :goto_0
    sput-object v0, Lhju;->a:Landroid/hardware/camera2/CameraCharacteristics$Key;

    sget-boolean v0, Lhju;->u:Z

    if-eqz v0, :cond_0

    invoke-static {}, Lhju;->e()Z
    ...
    :goto_1
    sput-object v0, Lhju;->b:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    :goto_2
    sput-object v0, Lhju;->c:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-static {v2}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v0

    sput-object v0, Lhju;->d:Ljava/lang/Byte;

    invoke-static {v3}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v0

    sput-object v0, Lhju;->e:Ljava/lang/Byte;

    invoke-static {v4}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v0

    sput-object v0, Lhju;->f:Ljava/lang/Byte;
    ...
    :goto_3
    sput-object v0, Lhju;->g:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_4
    sput-object v0, Lhju;->h:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_5
    sput-object v0, Lhju;->i:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_6
    sput-object v0, Lhju;->j:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_7
    sput-object v0, Lhju;->k:Landroid/hardware/camera2/CaptureResult$Key;

    sget-boolean v0, Lhju;->u:Z

    if-eqz v0, :cond_16

    invoke-static {}, Lhju;->c()Z
    ...
    :goto_8
    sput-object v0, Lhju;->l:Landroid/hardware/camera2/CaptureResult$Key;
    ...
    :goto_9
    sput-object v0, Lhju;->m:Landroid/hardware/camera2/CaptureResult$Key;

    sget-boolean v0, Lhju;->u:Z

    if-eqz v0, :cond_18

    invoke-static {}, Lhju;->d()Z
    ...
    :goto_a
    sput-object v0, Lhju;->n:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-static {}, Lhju;->f()Z
    ...
    :goto_b
    sput-object v0, Lhju;->o:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-static {}, Lhju;->h()Z

    sget-boolean v0, Lhju;->u:Z

    if-eqz v0, :cond_6

    invoke-static {}, Lhju;->a()Z
    ...
    :goto_c
    sput-object v0, Lhju;->p:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    :goto_d
    sput-object v0, Lhju;->q:Landroid/hardware/camera2/CameraCharacteristics$Key;

    sget-boolean v0, Lhju;->u:Z

    if-eqz v0, :cond_1c

    invoke-static {}, Lhju;->i()Z
    ...
    :goto_e
    sput-object v0, Lhju;->r:Landroid/hardware/camera2/CaptureRequest$Key;
    ...
    sput-object v0, Lhju;->s:Ljava/lang/Integer;
    ...
    :cond_d
    sput-object v1, Lhju;->t:Landroid/hardware/camera2/CaptureResult$Key;
