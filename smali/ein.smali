...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lein;->a:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Leht;Lejr;Lekb;Leim;Leix;Lhbx;Lbvw;)V
    .locals 5
    ...
    iput-boolean v4, p0, Lein;->d:Z

    new-instance v0, Ljava/util/concurrent/Semaphore;

    invoke-direct {v0, v4}, Ljava/util/concurrent/Semaphore;-><init>(I)V

    iput-object v0, p0, Lein;->m:Ljava/util/concurrent/Semaphore;
    ...
    iput-object v0, p0, Lein;->n:Ljava/util/Vector;

    iput v4, p0, Lein;->o:I

    iput-object v2, p0, Lein;->p:Ljava/io/FileWriter;

    iput-boolean v4, p0, Lein;->s:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, Lein;->t:Z

    iput-boolean v4, p0, Lein;->u:Z

    iput-boolean v4, p0, Lein;->w:Z

    iput-boolean v4, p0, Lein;->x:Z

    iput-object v2, p0, Lein;->y:Lekq;

    iput-object v2, p0, Lein;->z:Lekq;
    ...
    iput-object v0, p0, Lein;->F:Ljava/util/List;
    ...
    iput-object v0, p0, Lein;->H:Lejb;

    iput-boolean v4, p0, Lein;->I:Z

    new-instance v0, Leir;

    invoke-direct {v0, p0}, Leir;-><init>(Lein;)V

    iput-object v0, p0, Lein;->K:Laan;

    new-instance v0, Leis;

    invoke-direct {v0}, Leis;-><init>()V

    iput-object v0, p0, Lein;->L:Laam;

    new-instance v0, Leit;

    invoke-direct {v0, p0}, Leit;-><init>(Lein;)V

    iput-object v0, p0, Lein;->M:Laaz;

    new-instance v0, Leiu;

    invoke-direct {v0, p0}, Leiu;-><init>(Lein;)V

    iput-object v0, p0, Lein;->N:Laam;

    iput-object p8, p0, Lein;->P:Lbvw;

    iput-object p1, p0, Lein;->q:Landroid/content/Context;

    iput-object p3, p0, Lein;->h:Lejr;

    iput-object p4, p0, Lein;->Q:Lekb;

    iput-object p5, p0, Lein;->C:Leim;

    iput-object p7, p0, Lein;->r:Lhbx;
    ...
    iput-object v0, p0, Lein;->J:Landroid/os/Handler;

    :try_start_0
    new-instance v0, Ljava/io/FileWriter;

    iget-object v1, p0, Lein;->Q:Lekb;

    iget-object v1, v1, Lekb;->f:Ljava/lang/String;

    invoke-direct {v0, v1}, Ljava/io/FileWriter;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lein;->p:Ljava/io/FileWriter;
    :try_end_0
    ...
    iput-object v0, p0, Lein;->B:Landroid/os/HandlerThread;

    iget-object v0, p0, Lein;->B:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->start()V

    new-instance v0, Landroid/os/Handler;

    iget-object v1, p0, Lein;->B:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, Lein;->A:Landroid/os/Handler;

    iput-object p2, p0, Lein;->c:Leht;

    iget-object v0, p0, Lein;->c:Leht;
    ...
    sget-object v1, Lein;->a:Ljava/lang/String;

    const-string v2, "Could not create file writer for : "

    iget-object v0, p0, Lein;->Q:Lekb;

    iget-object v0, v0, Lekb;->f:Ljava/lang/String;
    ...
    :cond_1
    iput-object p6, p0, Lein;->b:Leix;

    iget-object v0, p0, Lein;->b:Leix;

    iput-object p0, v0, Leix;->H:Lein;

    iget-object v0, p0, Lein;->P:Lbvw;
    ...
    iput-object p3, v0, Leix;->G:Lejr;

    new-instance v1, Lejk;

    invoke-direct {v1}, Lejk;-><init>()V

    iput-object v1, v0, Leix;->A:Lejk;

    iget-object v0, p0, Lein;->h:Lejr;

    new-instance v1, Leio;

    invoke-direct {v1, p0}, Leio;-><init>(Lein;)V

    iput-object v1, v0, Lejr;->p:Lekq;

    iget-object v0, p0, Lein;->H:Lejb;

    invoke-static {}, Leik;->b()Z

    move-result v1

    iput-boolean v1, v0, Lejb;->c:Z

    iget-object v0, p0, Lein;->q:Landroid/content/Context;
    ...
    invoke-static {v0, v1, v4}, Lhzw;->a(Landroid/content/ContentResolver;Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Lein;->x:Z
...
.method static synthetic a(Lein;)Lbvw;
    .locals 1
...
.method public final a(I)V
    ...
    iget-object v0, v0, Lekb;->c:Ljava/lang/String;

    add-int/lit8 v1, p1, -0x1

    packed-switch v1, :pswitch_data_0

    invoke-virtual {p0}, Lein;->d()F
    ...
    invoke-virtual {v2, v0}, Leji;->a([F)V

    :cond_2
    iput-boolean v3, v1, Leix;->w:Z
...
.method public final b()V
    ...
    iget-object v2, p0, Lein;->b:Leix;

    iget-object v5, v2, Leix;->b:Lejc;
    ...
    iput-object v2, v5, Lejc;->a:Ljava/nio/FloatBuffer;
    ...
    iput-object v2, v5, Lejc;->b:Ljava/nio/FloatBuffer;
    ...
    iput-object v2, v5, Lejc;->c:Ljava/nio/ShortBuffer;
    ...
    iput-object v2, v5, Lejc;->i:Ljava/nio/ShortBuffer;
    ...
    iget-object v4, v5, Lejc;->a:Ljava/nio/FloatBuffer;
    ...
    iget-object v8, v5, Lejc;->b:Ljava/nio/FloatBuffer;

    invoke-virtual {v8, v3, v7}, Ljava/nio/FloatBuffer;->put(IF)Ljava/nio/FloatBuffer;

    iget-object v7, v5, Lejc;->b:Ljava/nio/FloatBuffer;
    ...
    iget-object v4, v5, Lejc;->c:Ljava/nio/ShortBuffer;
    ...
    iget-object v6, v5, Lejc;->i:Ljava/nio/ShortBuffer;
    ...
    iget-object v4, v5, Lejc;->i:Ljava/nio/ShortBuffer;
...
.method public final declared-synchronized c()V
    ...
    :try_start_1
    iput-boolean v0, p0, Lein;->u:Z

    iget-object v0, p0, Lein;->b:Leix;

    const/4 v1, 0x1

    iput-boolean v1, v0, Leix;->u:Z
    ...
    iget-object v2, v0, Leht;->a:Landroid/os/Handler;
    ...
    invoke-static {v0, v1}, Lekr;->a(Ljava/lang/String;Ljava/util/List;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    iget-object v0, p0, Lein;->p:Ljava/io/FileWriter;
...
.method public final declared-synchronized f()I
    ...
    iget-object v2, p0, Lein;->E:Ljava/util/List;
    ...
    :try_start_2
    iget-object v1, p0, Lein;->p:Ljava/io/FileWriter;
    ...
    iget-object v3, p0, Lein;->Q:Lekb;

    iget-object v3, v3, Lekb;->f:Ljava/lang/String;
    ...
    iput-boolean v0, p0, Lein;->w:Z

    :cond_2
    const/4 v0, 0x1

    iput-boolean v0, p0, Lein;->I:Z
