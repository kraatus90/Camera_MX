...
# direct methods
.method public constructor <init>(Landroid/hardware/camera2/CameraManager;Liih;Ljava/util/concurrent/Executor;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lbll;->c:Landroid/hardware/camera2/CameraManager;

    iput-object p2, p0, Lbll;->d:Liih;

    iput-object p3, p0, Lbll;->e:Ljava/util/concurrent/Executor;
...
.method private final c()Lkeh;
    ...
    iget-object v0, p0, Lbll;->e:Ljava/util/concurrent/Executor;

    new-instance v1, Lblm;

    invoke-direct {v1, p0}, Lblm;-><init>(Lbll;)V
...
.method public final a()Lkeh;
    ...
    :try_start_0
    iget-object v0, p0, Lbll;->c:Landroid/hardware/camera2/CameraManager;
...
.method final b()Z
    ...
    invoke-direct {v2, v4}, Lbln;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_3

    :try_start_2
    iget-object v1, p0, Lbll;->c:Landroid/hardware/camera2/CameraManager;

    const-string v6, "PollUntilReconnect"

    invoke-static {v5, v6}, Liat;->a(Liaw;Ljava/lang/String;)Landroid/os/Handler;
    ...
    iget-object v6, p0, Lbll;->c:Landroid/hardware/camera2/CameraManager;
    ...
    iget-object v1, p0, Lbll;->d:Liih;

    sget-object v4, Liii;->a:Liii;

    invoke-interface {v1, v4}, Liih;->a(Liii;)V
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_6
    .catchall {:try_start_2 .. :try_end_2} :catchall_4

    :try_start_3
    invoke-virtual {v5}, Liaw;->close()V
    :try_end_3
    ...
    sget-object v3, Liii;->c:Liii;

    invoke-interface {v1, v3}, Liih;->a(Liii;)V
    :try_end_9
