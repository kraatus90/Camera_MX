...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;Lhjr;Lcom/google/android/apps/refocus/processing/ProgressCallback;Landroid/graphics/Bitmap;)V
    .locals 2
    ...
    iput-object p2, p0, Lhjp;->c:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    iput-object v0, p0, Lhjp;->f:Landroid/os/Handler;

    iput-object p3, p0, Lhjp;->a:Lhjr;

    iput-object p4, p0, Lhjp;->d:Lcom/google/android/apps/refocus/processing/ProgressCallback;

    iput-object p5, p0, Lhjp;->e:Landroid/graphics/Bitmap;
...
.method public final run()V
    ...
    iget-object v1, p0, Lhjp;->c:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;

    iget-object v2, p0, Lhjp;->d:Lcom/google/android/apps/refocus/processing/ProgressCallback;

    iget-object v3, p0, Lhjp;->e:Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lhjp;->f:Landroid/os/Handler;

    new-instance v2, Lhjq;

    invoke-direct {v2, p0, v0}, Lhjq;-><init>(Lhjp;Landroid/graphics/Bitmap;)V
