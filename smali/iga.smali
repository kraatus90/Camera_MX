...
# instance fields
.field private final synthetic a:Lifl;


# direct methods
.method public constructor <init>(Lifl;Ljava/lang/String;)V
    .locals 0

    iput-object p1, p0, Liga;->a:Lifl;
...
.method public final run()V
    ...
    :cond_0
    iget-object v0, p0, Liga;->a:Lifl;

    new-instance v2, Landroid/media/MediaCodec$BufferInfo;

    invoke-direct {v2}, Landroid/media/MediaCodec$BufferInfo;-><init>()V

    iget-object v3, v0, Lifl;->b:Landroid/media/MediaCodec;
    ...
    iget-object v2, v0, Lifl;->d:Lifi;

    invoke-virtual {v2}, Lifi;->c()Z
    ...
    :try_start_0
    iget-object v5, v3, Lifi;->e:Lifz;

    sget-object v6, Lifz;->a:Lifz;
    ...
    :cond_2
    :try_start_1
    iget-object v5, v3, Lifi;->g:Lifk;

    iget-boolean v5, v5, Lifk;->a:Z
    ...
    iget-object v6, v3, Lifi;->a:Landroid/media/MediaMuxer;

    invoke-virtual {v6, v2}, Landroid/media/MediaMuxer;->addTrack(Landroid/media/MediaFormat;)I

    move-result v6

    invoke-virtual {v5, v6}, Lifk;->a(I)V

    iget-object v5, v3, Lifi;->g:Lifk;

    iput-object v2, v5, Lifk;->d:Landroid/media/MediaFormat;

    const-string v2, "MediaMuxerMul"

    iget-object v3, v3, Lifi;->g:Lifk;

    invoke-virtual {v3}, Lifk;->a()I
    ...
    :cond_5
    iget-object v4, v0, Lifl;->b:Landroid/media/MediaCodec;
    ...
    iget-object v5, v0, Lifl;->d:Lifi;

    invoke-virtual {v5}, Lifi;->c()Z
    ...
    invoke-virtual {v5, v6, v7}, Lifi;->a(J)V
    ...
    invoke-virtual {v5, v4, v2}, Lifi;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
