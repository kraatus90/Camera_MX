...
# direct methods
.method public constructor <init>(Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraManager;Liih;Lihs;Liom;Ljava/lang/String;)V
    .locals 1
    ...
    iput-boolean v0, p0, Liia;->k:Z

    iput-boolean v0, p0, Liia;->l:Z

    iput-object p7, p0, Liia;->a:Ljava/lang/String;

    iput-object p3, p0, Liia;->e:Landroid/hardware/camera2/CameraManager;

    iput-object p6, p0, Liia;->i:Liom;

    iput-object p5, p0, Liia;->b:Lihs;

    iput-object p4, p0, Liia;->f:Liih;

    iput-object p1, p0, Liia;->h:Landroid/os/Handler;
    ...
    iput-object v0, p0, Liia;->d:Liij;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Liia;->j:Ljava/lang/Object;
...
.method private final a(Liij;ZJJ)Liie;
    .locals 5
    ...
    iget-object v1, p0, Liia;->b:Lihs;

    invoke-direct {v0, v1}, Liid;-><init>(Lihs;)V

    invoke-virtual {p1, v0}, Liij;->a(Lihx;)V
    ...
    :try_start_0
    iget-object v1, p0, Liia;->e:Landroid/hardware/camera2/CameraManager;

    iget-object v2, p0, Liia;->a:Ljava/lang/String;

    new-instance v3, Lihu;

    iget-object v4, p0, Liia;->a:Ljava/lang/String;

    invoke-direct {v3, p1, v4}, Lihu;-><init>(Lihx;Ljava/lang/String;)V

    iget-object v4, p0, Liia;->h:Landroid/os/Handler;
    ...
    invoke-virtual {v0, v2, v3}, Liid;->a(J)Liie;
    :try_end_0
    ...
    invoke-direct {p0, v1, v0, p2}, Liia;->a(Ljava/lang/String;Ljava/lang/Exception;Z)V
...
.method private final a(Ljava/lang/String;Ljava/lang/Exception;Z)V
    ...
    iget-object v0, p0, Liia;->f:Liih;

    sget-object v1, Liii;->c:Liii;

    invoke-interface {v0, v1}, Liih;->a(Liii;)V
...
.method public final a()Liij;
    ...
    iget-object v1, p0, Liia;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v0, p0, Liia;->k:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, Liia;->l:Z

    if-eqz v0, :cond_1

    :cond_0
    iget-object v0, p0, Liia;->d:Liij;
    ...
    iget-object v0, p0, Liia;->g:Ljava/util/concurrent/Executor;

    new-instance v1, Liib;

    invoke-direct {v1, p0}, Liib;-><init>(Liia;)V
...
.method final b()Liij;
    ...
    invoke-direct {v8, p0}, Liic;-><init>(Liia;)V

    iget-object v6, p0, Liia;->e:Landroid/hardware/camera2/CameraManager;

    iget-object v7, p0, Liia;->h:Landroid/os/Handler;
    ...
    :try_start_2
    iget-boolean v6, p0, Liia;->l:Z

    if-eqz v6, :cond_0

    invoke-virtual {v2}, Liij;->close()V

    monitor-exit v1
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    iget-object v0, p0, Liia;->e:Landroid/hardware/camera2/CameraManager;
    ...
    invoke-direct/range {v1 .. v7}, Liia;->a(Liij;ZJJ)Liie;
    ...
    iget-object v2, p0, Liia;->e:Landroid/hardware/camera2/CameraManager;
    ...
    invoke-direct {p0, v3}, Liia;->a(Z)V

    const/4 v0, 0x5

    invoke-virtual {v2, v0}, Liij;->a(I)V
    :try_end_7
    ...
    iget-object v6, p0, Liia;->j:Ljava/lang/Object;
    ...
    iget-object v0, p0, Liia;->b:Lihs;

    const-string v6, "interruptibleTimeout#wait"

    invoke-interface {v0, v6}, Lihs;->a(Ljava/lang/String;)V
    :try_end_c
    .catchall {:try_start_c .. :try_end_c} :catchall_1

    :try_start_d
    iget-object v6, p0, Liia;->c:Ljava/lang/Object;
    ...
    iget-object v7, p0, Liia;->a:Ljava/lang/String;
