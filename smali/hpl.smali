...
# direct methods
.method constructor <init>(Lhlm;Lcom/google/android/gms/feedback/FeedbackOptions;Landroid/os/Bundle;JLcom/google/android/gms/googlehelp/GoogleHelp;)V
    .locals 2

    iput-object p2, p0, Lhpl;->a:Lcom/google/android/gms/feedback/FeedbackOptions;

    iput-object p3, p0, Lhpl;->b:Landroid/os/Bundle;

    iput-wide p4, p0, Lhpl;->c:J

    iput-object p6, p0, Lhpl;->d:Lcom/google/android/gms/googlehelp/GoogleHelp;
...
.method protected final a(Lhpp;)V
    ...
    :try_start_0
    iget-object v0, p0, Lhpl;->a:Lcom/google/android/gms/feedback/FeedbackOptions;

    iget-object v1, p0, Lhpl;->b:Landroid/os/Bundle;

    iget-wide v2, p0, Lhpl;->c:J

    iget-object v4, p0, Lhpl;->d:Lcom/google/android/gms/googlehelp/GoogleHelp;

    new-instance v5, Lhpm;

    invoke-direct {v5, p0}, Lhpm;-><init>(Lhpl;)V
    ...
    :goto_2
    invoke-interface {v5}, Lhpc;->asBinder()Landroid/os/IBinder;
    ...
    invoke-virtual {p0, v0}, Lhpl;->c(Lcom/google/android/gms/common/api/Status;)V
