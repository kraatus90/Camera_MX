...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lhlc;->c:Z

    sput-boolean v1, Lhlc;->d:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lhlc;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lhlc;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lhlc;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static c(Landroid/content/Context;)I
    ...
    sget-object v3, Lhlc;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lhnl;->a(Landroid/content/Context;)I
    ...
    :cond_1
    invoke-static {p0}, Lhmr;->a(Landroid/content/Context;)Z

    move-result v3

    if-nez v3, :cond_4

    sget-object v3, Lhmr;->a:Ljava/lang/Boolean;
    ...
    sput-object v3, Lhmr;->a:Ljava/lang/Boolean;
    ...
    sget-object v4, Lhnw;->a:[Lhnt;

    invoke-static {v3, v4}, Lhld;->a(Landroid/content/pm/PackageInfo;[Lhnt;)Lhnt;
    ...
    :cond_5
    new-array v4, v1, [Lhnt;

    aput-object v3, v4, v2

    invoke-static {v6, v4}, Lhld;->a(Landroid/content/pm/PackageInfo;[Lhnt;)Lhnt;
    ...
    :cond_6
    sget-object v3, Lhnw;->a:[Lhnt;

    invoke-static {v6, v3}, Lhld;->a(Landroid/content/pm/PackageInfo;[Lhnt;)Lhnt;
...
.method public static d(Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, v3, v4}, Lhqt;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    new-array v3, v3, [Lhnt;

    const/4 v4, 0x0

    sget-object v5, Lhnw;->a:[Lhnt;
    ...
    invoke-static {v2, v3}, Lhld;->a(Landroid/content/pm/PackageInfo;[Lhnt;)Lhnt;
