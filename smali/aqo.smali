...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Larz;->a(Lasd;)Lgw;

    move-result-object v0

    sput-object v0, Laqo;->a:Lgw;
...
.method public constructor <init>()V
    ...
    :goto_0
    iput-object v0, p0, Laqo;->s:Ljava/lang/String;
...
.method private final a(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Laqo;->h:Laqm;

    iget-object v0, v0, Laqm;->w:Landroid/content/res/Resources$Theme;
    ...
    :cond_0
    iget-object v0, p0, Laqo;->d:Landroid/content/Context;
...
.method private final a(Lagp;I)V
    ...
    iget-object v0, p0, Laqo;->t:Lash;

    invoke-virtual {v0}, Lash;->a()V

    iget-object v0, p0, Laqo;->e:Lacl;
    ...
    iget-object v4, p0, Laqo;->f:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Laqo;->n()Z

    invoke-interface {v0, p1}, Laql;->a(Lagp;)Z

    :cond_1
    invoke-direct {p0}, Laqo;->m()Z

    move-result v0

    if-eqz v0, :cond_5

    iget-object v0, p0, Laqo;->f:Ljava/lang/Object;

    if-nez v0, :cond_7

    invoke-direct {p0}, Laqo;->l()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Laqo;->x:Landroid/graphics/drawable/Drawable;

    if-nez v0, :cond_2

    iget-object v0, p0, Laqo;->h:Laqm;

    iget-object v0, v0, Laqm;->g:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, Laqo;->x:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v0}, Laqo;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0}, Laqo;->k()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    :cond_4
    iget-object v1, p0, Laqo;->l:Laqy;

    invoke-interface {v1, v0}, Laqy;->c(Landroid/graphics/drawable/Drawable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_5
    iput-boolean v3, p0, Laqo;->q:Z

    iget-object v0, p0, Laqo;->c:Laqi;
...
.method private final a(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Laqo;->s:Ljava/lang/String;
...
.method private final k()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Laqo;->y:Landroid/graphics/drawable/Drawable;

    if-nez v0, :cond_0

    iget-object v0, p0, Laqo;->h:Laqm;

    iget-object v0, v0, Laqm;->i:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, Laqo;->y:Landroid/graphics/drawable/Drawable;
...
.method private final l()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Laqo;->z:Landroid/graphics/drawable/Drawable;

    if-nez v0, :cond_0

    iget-object v0, p0, Laqo;->h:Laqm;

    iget-object v0, v0, Laqm;->q:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, Laqo;->z:Landroid/graphics/drawable/Drawable;
...
.method private final m()Z
    ...
    invoke-interface {v0, p0}, Laqi;->c(Laqh;)Z
...
.method public final a()V
    ...
    invoke-direct {p0}, Laqo;->j()V

    iget-object v0, p0, Laqo;->t:Lash;

    invoke-virtual {v0}, Lash;->a()V

    invoke-static {}, Lart;->a()J

    move-result-wide v0

    iput-wide v0, p0, Laqo;->w:J
    ...
    invoke-direct {p0, v1, v0}, Laqo;->a(Lagp;I)V
    ...
    iget-object v0, p0, Laqo;->u:Lagw;

    sget-object v1, Ladm;->e:Ladm;

    invoke-virtual {p0, v0, v1}, Laqo;->a(Lagw;Ladm;)V
    ...
    iget-object v0, p0, Laqo;->l:Laqy;

    invoke-direct {p0}, Laqo;->k()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-interface {v0, v1}, Laqy;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-wide v0, p0, Laqo;->w:J

    invoke-static {v0, v1}, Lart;->a(J)D
    ...
    invoke-direct {p0, v0}, Laqo;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p0}, Laqy;->a(Laqx;)V
...
.method public final a(II)V
    ...
    iget-object v2, v0, Laqo;->t:Lash;

    invoke-virtual {v2}, Lash;->a()V

    sget-boolean v2, Laqo;->r:Z

    if-eqz v2, :cond_0

    move-object/from16 v0, p0

    iget-wide v2, v0, Laqo;->w:J

    invoke-static {v2, v3}, Lart;->a(J)D
    ...
    invoke-direct {v0, v2}, Laqo;->a(Ljava/lang/String;)V
    ...
    iget-object v2, v0, Laqo;->h:Laqm;

    iget v2, v2, Laqm;->d:F

    move/from16 v0, p1

    invoke-static {v0, v2}, Laqo;->a(IF)I
    ...
    iget-object v13, v0, Laqo;->n:Lagb;

    move-object/from16 v0, p0

    iget-object v14, v0, Laqo;->e:Lacl;

    move-object/from16 v0, p0

    iget-object v3, v0, Laqo;->f:Ljava/lang/Object;

    move-object/from16 v0, p0

    iget-object v2, v0, Laqo;->h:Laqm;

    iget-object v4, v2, Laqm;->n:Ladu;
    ...
    iget-object v8, v2, Laqm;->u:Ljava/lang/Class;

    move-object/from16 v0, p0

    iget-object v9, v0, Laqo;->g:Ljava/lang/Class;

    move-object/from16 v0, p0

    iget-object v15, v0, Laqo;->k:Lacn;

    move-object/from16 v0, p0

    iget-object v2, v0, Laqo;->h:Laqm;

    iget-object v0, v2, Laqm;->e:Lafv;
    ...
    iget-object v7, v2, Laqm;->t:Ljava/util/Map;

    move-object/from16 v0, p0

    iget-object v2, v0, Laqo;->h:Laqm;

    iget-boolean v0, v2, Laqm;->o:Z
    ...
    iget-object v10, v2, Laqm;->s:Lady;

    move-object/from16 v0, p0

    iget-object v2, v0, Laqo;->h:Laqm;

    iget-boolean v0, v2, Laqm;->k:Z
    ...
    invoke-interface {v0, v11, v3}, Laqn;->a(Lagw;Ladm;)V
    ...
    invoke-virtual {v11, v0}, Lagh;->a(Laqn;)V
    ...
    invoke-direct {v2, v0, v11}, Lagg;-><init>(Laqn;Lagh;)V
    ...
    invoke-static {v11, v12}, Lazz;->a(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v12, v0}, Lazz;->a(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
...
.method public final a(Lagp;)V
    ...
    invoke-direct {p0, p1, v0}, Laqo;->a(Lagp;I)V
...
.method public final a(Lagw;Ladm;)V
    ...
    iput-object v0, p0, Laqo;->v:Lagg;

    if-nez p1, :cond_1

    new-instance v0, Lagp;

    iget-object v1, p0, Laqo;->g:Ljava/lang/Class;
    ...
    invoke-direct {p0, v0, v8}, Laqo;->a(Lagp;I)V
    ...
    iget-object v0, p0, Laqo;->g:Ljava/lang/Class;
    ...
    :cond_2
    invoke-direct {p0, p1}, Laqo;->a(Lagw;)V
    ...
    invoke-direct {p0, v1, v8}, Laqo;->a(Lagp;I)V
    ...
    invoke-interface {v0, p0}, Laqi;->b(Laqh;)Z
    ...
    iget-object v6, p0, Laqo;->f:Ljava/lang/Object;
    ...
    iget-wide v10, p0, Laqo;->w:J

    invoke-static {v10, v11}, Lart;->a(J)D
    ...
    invoke-interface {v0, v3}, Laql;->a(Ljava/lang/Object;)Z

    :cond_a
    iget-object v0, p0, Laqo;->o:Larj;

    invoke-interface {v0, p2}, Larj;->a(Ladm;)Larh;

    move-result-object v0

    iget-object v2, p0, Laqo;->l:Laqy;

    invoke-interface {v2, v3, v0}, Laqy;->a(Ljava/lang/Object;Larh;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iput-boolean v1, p0, Laqo;->q:Z
...
.method public final a(Laqh;)Z
    ...
    iget-object v1, p0, Laqo;->f:Ljava/lang/Object;

    iget-object v2, p1, Laqo;->f:Ljava/lang/Object;

    invoke-static {v1, v2}, Larx;->b(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v2, p1, Laqo;->g:Ljava/lang/Class;
    ...
    iget-object v1, p0, Laqo;->h:Laqm;

    iget-object v2, p1, Laqo;->h:Laqm;

    invoke-virtual {v1, v2}, Laqm;->equals(Ljava/lang/Object;)Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v1, p0, Laqo;->k:Lacn;

    iget-object v2, p1, Laqo;->k:Lacn;
...
.method public final d()V
    ...
    iget-object v1, p0, Laqo;->t:Lash;

    invoke-virtual {v1}, Lash;->a()V
    ...
    invoke-interface {v1, p0}, Laqy;->b(Laqx;)V

    sget v1, Lep;->n:I

    iput v1, p0, Laqo;->p:I

    iget-object v1, p0, Laqo;->v:Lagg;
    ...
    iget-object v1, v1, Lagg;->b:Laqn;

    invoke-static {}, Larx;->a()V

    iget-object v3, v2, Lagh;->b:Lash;

    invoke-virtual {v3}, Lash;->a()V
    ...
    :cond_4
    iget-object v1, p0, Laqo;->u:Lagw;

    if-eqz v1, :cond_5

    iget-object v1, p0, Laqo;->u:Lagw;

    invoke-direct {p0, v1}, Laqo;->a(Lagw;)V

    :cond_5
    iget-object v1, p0, Laqo;->c:Laqi;

    if-eqz v1, :cond_6

    iget-object v1, p0, Laqo;->c:Laqi;

    invoke-interface {v1, p0}, Laqi;->d(Laqh;)Z
    ...
    invoke-interface {v0, v1}, Laqy;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public final i()V
    ...
    iput-object v0, p0, Laqo;->d:Landroid/content/Context;

    iput-object v0, p0, Laqo;->e:Lacl;

    iput-object v0, p0, Laqo;->f:Ljava/lang/Object;

    iput-object v0, p0, Laqo;->g:Ljava/lang/Class;

    iput-object v0, p0, Laqo;->h:Laqm;

    iput v1, p0, Laqo;->i:I

    iput v1, p0, Laqo;->j:I

    iput-object v0, p0, Laqo;->l:Laqy;

    iput-object v0, p0, Laqo;->b:Laql;

    iput-object v0, p0, Laqo;->c:Laqi;

    iput-object v0, p0, Laqo;->o:Larj;
