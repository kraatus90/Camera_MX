...
# direct methods
.method constructor <init>(Lbnd;ZLandroid/app/Activity;Lbnl;Ljava/lang/Exception;)V
    .locals 0
    ...
    iput-object p3, p0, Lbne;->c:Landroid/app/Activity;

    iput-object p4, p0, Lbne;->d:Lbnl;

    iput-object p5, p0, Lbne;->e:Ljava/lang/Exception;
...
.method public final run()V
    ...
    iget-object v2, p0, Lbne;->c:Landroid/app/Activity;

    iget-object v3, p0, Lbne;->d:Lbnl;

    iget-object v4, p0, Lbne;->e:Ljava/lang/Exception;

    if-nez v1, :cond_0

    iget-object v1, v0, Lbnd;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v5, v0, v2}, Lbnf;-><init>(Lbnd;Landroid/app/Activity;)V

    new-instance v6, Lbng;

    invoke-direct {v6, v0, v2, v3, v4}, Lbng;-><init>(Lbnd;Landroid/app/Activity;ILjava/lang/Exception;)V
    ...
    sget-object v3, Lbnd;->a:Ljava/lang/String;
    ...
    :cond_2
    iget-object v1, v0, Lbnd;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0, v1}, Lbnd;->a(Ljava/lang/String;)V
