...
.method static constructor <clinit>()V
    ...
    sput-object v0, Leng;->a:Ljava/lang/String;
    ...
    sput-object v0, Leng;->i:Landroid/net/Uri;
...
.method constructor <init>(Landroid/content/Context;Lenm;)V
    ...
    iput-boolean v0, p0, Leng;->f:Z

    iput-object p2, p0, Leng;->h:Lenm;

    new-instance v0, Lhbl;

    new-instance v1, Lhrk;

    invoke-direct {v1, p1}, Lhrk;-><init>(Landroid/content/Context;)V

    sget-object v2, Lhvg;->a:Lhlf;
    ...
    invoke-static {p0, v2}, Lhmr;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v2, v1, Lhrk;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lhrk;->c:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Leng;->b:Lhbl;

    iput-object p1, p0, Leng;->d:Landroid/content/Context;
...
.method static a(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Leng;->b(Landroid/content/Context;)I
...
.method private static b(Landroid/content/Context;)I
    ...
    :try_start_0
    sget-object v1, Leng;->i:Landroid/net/Uri;
    ...
    :goto_2
    :try_start_2
    sget-object v2, Leng;->a:Ljava/lang/String;
...
.method public final a(Z)Lkeh;
    ...
    invoke-direct {v1, p0, v0, p1}, Lenh;-><init>(Leng;Lket;Z)V

    const/4 v2, 0x0

    new-array v2, v2, [Ljava/lang/Void;

    invoke-virtual {v1, v2}, Lenh;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public final b()Landroid/location/Location;
    ...
    iget-object v1, v1, Lhbn;->a:Lhbl;

    iget-object v1, v1, Lhbl;->a:Lhlm;

    invoke-static {v1}, Lhvc;->a(Lhlm;)Landroid/location/Location;
...
.method final c()V
    ...
    iget-boolean v0, p0, Leng;->f:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Leng;->c:Lhbn;
    ...
    invoke-direct {v1, v0, p0}, Lhvn;-><init>(Lhlm;Lhvf;)V

    invoke-virtual {v0, v1}, Lhlm;->b(Lhsy;)Lhsy;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    :cond_0
    :goto_0
    iput-boolean v3, p0, Leng;->f:Z
