...
.method private static a(Leql;)Leqm;
    .locals 15
    ...
    invoke-virtual {p0}, Leql;->a()Ljava/io/InputStream;
    ...
    invoke-static {v0}, Lepy;->a(Ljava/io/InputStream;)Lwk;
    ...
    invoke-static {v8, v0}, Leqm;->b(Lwk;Ljava/lang/String;)Ljava/util/Calendar;
    ...
    invoke-static {v8, v0}, Leqm;->a(Lwk;Ljava/lang/String;)I

    const-string v0, "ProjectionType"

    const-string v3, "http://ns.google.com/photos/1.0/panorama/"

    invoke-interface {v8, v3, v0}, Lwk;->d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v8, v3, v0}, Lwk;->j(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v8, v3, v0}, Lwk;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    invoke-static {v8, v0}, Leqm;->a(Lwk;Ljava/lang/String;)I
    :try_end_2
    .catch Lwi; {:try_start_2 .. :try_end_2} :catch_3
    ...
    invoke-static {v8, v0}, Leqm;->a(Lwk;Ljava/lang/String;)I
    :try_end_3
    .catch Lwi; {:try_start_3 .. :try_end_3} :catch_4
    ...
    invoke-static {v8, v0}, Leqm;->a(Lwk;Ljava/lang/String;)I
    :try_end_4
    .catch Lwi; {:try_start_4 .. :try_end_4} :catch_5
    ...
    invoke-static {v8, v0}, Leqm;->a(Lwk;Ljava/lang/String;)I
    :try_end_5
    .catch Lwi; {:try_start_5 .. :try_end_5} :catch_6
    ...
    invoke-static {v8, v0}, Leqm;->a(Lwk;Ljava/lang/String;)I
    :try_end_6
    .catch Lwi; {:try_start_6 .. :try_end_6} :catch_7
    ...
    sget-object v3, Leqm;->a:Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Leqm;->a(DDD)Z
    ...
    invoke-direct {v0, v13, v14}, Leqm;-><init>(II)V
    ...
    invoke-direct/range {v0 .. v5}, Leqm;-><init>(ZIIII)V
...
.method public static a(Ljava/lang/String;)Leqm;
    .locals 1

    new-instance v0, Leql;

    invoke-direct {v0, p0}, Leql;-><init>(Ljava/lang/String;)V

    invoke-static {v0}, Leqm;->a(Leql;)Leqm;
...
.method private static b(Lwk;Ljava/lang/String;)Ljava/util/Calendar;
    .locals 1
    ...
    invoke-interface {p0, v0, p1}, Lwk;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Calendar;
