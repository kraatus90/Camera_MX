...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->b:Lgyk;
...
.method public final a()Lgrj;
    ...
    invoke-static {v0, v1, v2, v3}, Lhaq;->a(Landroid/view/Display;Landroid/content/Context;II)Lhaq;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->j:Lhaq;

    iget-object v0, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->j:Lhaq;
    ...
    iget-object v3, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->j:Lhaq;

    invoke-virtual {p0}, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-static {v1, v2, v3, v0, v4}, Lgri;->a(Landroid/util/Size;Landroid/util/Size;Lhaq;ZLandroid/content/Context;)Lgrj;

    move-result-object v0

    sput-object v0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->a:Lgrj;

    :goto_1
    sget-object v0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->h:Ljava/lang/String;

    sget-object v1, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->a:Lgrj;
    ...
    sget-object v0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->a:Lgrj;
...
.method public final a(II)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->b:Lgyk;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->b:Lgyk;

    invoke-interface {v0, p1, p2}, Lgyk;->a(II)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->g:Lgyj;
    ...
    iget-object v3, v2, Lgyj;->a:Lgza;

    iget-object v2, v3, Lgza;->c:Lfwg;
    ...
    iget-object v6, v2, Lfwg;->b:Lcom/google/android/apps/camera/optionsbar/OptionsBarView;

    invoke-virtual {v6}, Lcom/google/android/apps/camera/optionsbar/OptionsBarView;->getX()F

    move-result v6

    iget-object v7, v2, Lfwg;->b:Lcom/google/android/apps/camera/optionsbar/OptionsBarView;

    invoke-virtual {v7}, Lcom/google/android/apps/camera/optionsbar/OptionsBarView;->getY()F

    move-result v7

    iget-object v8, v2, Lfwg;->b:Lcom/google/android/apps/camera/optionsbar/OptionsBarView;
    ...
    sget-object v4, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->a:Lgrj;

    invoke-virtual {v4}, Lgrj;->f()Landroid/graphics/Rect;
...
.method public onMeasure(II)V
    ...
    invoke-static {v0, v1, p1, p2}, Lhaq;->a(Landroid/view/Display;Landroid/content/Context;II)Lhaq;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->j:Lhaq;

    invoke-virtual {p0}, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->a()Lgrj;
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->j:Lhaq;

    invoke-virtual {v0, v1}, Lcom/google/android/apps/camera/bottombar/BottomBar;->setUiOrientation(Lhaq;)V
    ...
    iget-object v2, p0, Lcom/google/android/apps/camera/ui/views/MainActivityLayout;->j:Lhaq;

    invoke-virtual {v0, v2}, Lhal;->a(Lhaq;)V
