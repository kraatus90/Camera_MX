.class public Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;
...
.method public final a()V
    ...
    iget v2, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->c:I
    ...
    invoke-direct {v1, p0}, Lgyh;-><init>(Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;)V
    ...
    invoke-direct {v1, p0}, Lgyi;-><init>(Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->o:I

    int-to-float v1, v1

    iget v2, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->g:I

    int-to-float v2, v2

    iget-object v3, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->d:Landroid/graphics/Paint;
    ...
    iget v2, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->o:I

    iget v3, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->g:I

    sub-int/2addr v2, v3

    int-to-float v2, v2

    iget v3, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->n:I

    iget v4, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->g:I

    add-int/2addr v3, v4

    int-to-float v3, v3

    iget v4, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->o:I

    iget v5, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->g:I
    ...
    iget v0, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->i:I

    int-to-float v3, v0

    const/4 v4, 0x0

    iget-object v5, p0, Lcom/google/android/apps/camera/ui/views/DeterministicProgressOverlay;->l:Landroid/graphics/Paint;
