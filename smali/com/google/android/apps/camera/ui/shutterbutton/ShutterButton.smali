...
.field public clickEnabledObservable:Libw;
...
.field public final filteredClickEnabledObservable:Lick;

.field public gestureDetector:Lgvk;

.field public final isLongPressInProgress:Ljava/util/concurrent/atomic/AtomicBoolean;

.field public isVideoButtonAnimating:Z

.field public listener:Lgvg;

.field public modeTransitionAnimatorSet:Landroid/animation/AnimatorSet;

.field public oldPressed:Z

.field public onDrawListener:Lgud;

.field public touchCoordinate$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFCDGMQPBIC4NNAQBLEHKMOSPFAHNNAOR88DNMUSJ4D5N62T357C______0:Lhjv;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->clickEnabledObservable:Libw;

    iget-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->clickEnabledObservable:Libw;

    invoke-static {v0}, Licl;->b(Lick;)Lick;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->filteredClickEnabledObservable:Lick;
...
.method public static synthetic access$300(Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;)Lgvg;
    .locals 1

    iget-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->listener:Lgvg;
...
.method private animateMainButton(Lgue;Lgug;)V
    .locals 17
    ...
    invoke-static {v0, v2}, Lgvi;->a(Lgue;Landroid/content/res/Resources;)Lgvi;
    ...
    iget-object v3, v0, Lgug;->b:Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;

    invoke-virtual {v3}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->getSpec()Lgvi;

    move-result-object v3

    move-object/from16 v0, p2

    iput-object v3, v0, Lgug;->c:Lgvi;

    move-object/from16 v0, p2

    iput-object v2, v0, Lgug;->d:Lgvi;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->a()I

    move-result v3

    invoke-virtual {v2}, Lgvi;->a()I
    ...
    invoke-direct {v5, v0}, Lguh;-><init>(Lgug;)V

    move-object/from16 v0, p2

    invoke-virtual {v0, v3, v4, v5}, Lgug;->a(IILandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator;

    move-result-object v3

    move-object/from16 v0, p2

    iput-object v3, v0, Lgug;->e:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->d()I

    move-result v3

    invoke-virtual {v2}, Lgvi;->d()I
    ...
    invoke-direct {v5, v0}, Lgui;-><init>(Lgug;)V
    ...
    iput-object v3, v0, Lgug;->f:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->f()I

    move-result v3

    invoke-virtual {v2}, Lgvi;->f()I
    ...
    invoke-direct {v5, v0}, Lguo;-><init>(Lgug;)V
    ...
    iput-object v3, v0, Lgug;->g:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->j()I

    move-result v3

    invoke-virtual {v2}, Lgvi;->j()I
    ...
    invoke-direct {v5, v0}, Lgup;-><init>(Lgug;)V
    ...
    iput-object v3, v0, Lgug;->i:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v5, v0, v2}, Lguq;-><init>(Lgug;Lgvi;)V
    ...
    iput-object v3, v0, Lgug;->j:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->b()I

    move-result v3

    invoke-virtual {v2}, Lgvi;->b()I
    ...
    invoke-direct {v5, v0}, Lgur;-><init>(Lgug;)V
    ...
    iput-object v3, v0, Lgug;->h:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->l()I

    move-result v3

    invoke-virtual {v2}, Lgvi;->l()I
    ...
    invoke-direct {v5, v0}, Lgus;-><init>(Lgug;)V
    ...
    iput-object v3, v0, Lgug;->k:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v5, v0, v2}, Lgut;-><init>(Lgug;Lgvi;)V
    ...
    iput-object v3, v0, Lgug;->l:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->m()I

    move-result v3

    invoke-virtual {v2}, Lgvi;->m()I
    ...
    invoke-direct {v5, v0}, Lguu;-><init>(Lgug;)V
    ...
    iput-object v3, v0, Lgug;->m:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v5, v0, v2}, Lguv;-><init>(Lgug;Lgvi;)V
    ...
    iput-object v3, v0, Lgug;->n:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->g()I
    ...
    invoke-direct {v5, v0}, Lguj;-><init>(Lgug;)V
    ...
    iput-object v3, v0, Lgug;->p:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->h()I

    move-result v3

    invoke-virtual {v2}, Lgvi;->h()I
    ...
    invoke-direct {v5, v0}, Lguk;-><init>(Lgug;)V
    ...
    iput-object v3, v0, Lgug;->o:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->c:Lgvi;

    invoke-virtual {v3}, Lgvi;->o()I

    move-result v3

    invoke-virtual {v2}, Lgvi;->o()I
    ...
    invoke-direct {v4, v0}, Lgul;-><init>(Lgug;)V

    move-object/from16 v0, p2

    invoke-virtual {v0, v3, v2, v4}, Lgug;->a(IILandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator;

    move-result-object v2

    move-object/from16 v0, p2

    iput-object v2, v0, Lgug;->q:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v4, v0}, Lgum;-><init>(Lgug;)V

    move-object/from16 v0, p2

    invoke-virtual {v0, v2, v3, v4}, Lgug;->a(IILandroid/animation/ValueAnimator$AnimatorUpdateListener;)Landroid/animation/ValueAnimator;

    move-result-object v2

    move-object/from16 v0, p2

    iput-object v2, v0, Lgug;->r:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v2, v0, Lgug;->r:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->g:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v4, v0, Lgug;->e:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v5, v0, Lgug;->h:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v6, v0, Lgug;->f:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v7, v0, Lgug;->i:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v8, v0, Lgug;->j:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v9, v0, Lgug;->k:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v10, v0, Lgug;->m:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v11, v0, Lgug;->n:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v12, v0, Lgug;->l:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v13, v0, Lgug;->p:Landroid/animation/ValueAnimator;
    ...
    iget-object v0, v0, Lgug;->o:Landroid/animation/ValueAnimator;

    move-object/from16 v16, v0

    aput-object v16, v14, v15

    invoke-static/range {v2 .. v14}, Ljuh;->a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)Ljuh;

    move-result-object v2

    move-object/from16 v0, p2

    iput-object v2, v0, Lgug;->s:Ljava/util/List;

    move-object/from16 v0, p2

    iget-object v2, v0, Lgug;->c:Lgvi;

    invoke-virtual {v2}, Lgvi;->p()Lgue;

    move-result-object v2

    invoke-virtual {v2}, Lgue;->ordinal()I
    ...
    :pswitch_0
    invoke-virtual/range {p2 .. p2}, Lgug;->a()V

    :goto_1
    :pswitch_1
    move-object/from16 v0, p2

    iget-object v3, v0, Lgug;->r:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    iget-object v2, v0, Lgug;->s:Ljava/util/List;

    sget-object v4, Lgun;->a:Ljqv;

    new-instance v5, Ljsu;

    invoke-direct {v5, v2, v4}, Ljsu;-><init>(Ljava/util/Collection;Ljqv;)V
    ...
    invoke-direct {v3, v0}, Lgux;-><init>(Lgug;)V
    ...
    iget-object v3, v0, Lgug;->s:Ljava/util/List;
    ...
    iget-object v2, v0, Lgug;->f:Landroid/animation/ValueAnimator;

    move-object/from16 v0, p2

    invoke-virtual {v0, v2}, Lgug;->a(Landroid/animation/Animator;)Lguy;

    move-result-object v2

    const/16 v3, 0x15e

    invoke-virtual {v2, v3}, Lguy;->a(I)Lguy;

    move-result-object v2

    iget-object v3, v2, Lguy;->a:Landroid/animation/Animator;

    iget-object v4, v2, Lguy;->b:Lgug;

    iget-object v4, v4, Lgug;->v:Landroid/view/animation/Interpolator;

    invoke-virtual {v3, v4}, Landroid/animation/Animator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    invoke-virtual {v2}, Lguy;->c()Lguy;

    move-object/from16 v0, p2

    iget-object v2, v0, Lgug;->g:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v2, Lguy;->b:Lgug;

    iget-object v2, v2, Lgug;->u:Landroid/view/animation/Interpolator;
    ...
    iget-object v2, v0, Lgug;->e:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v0, Lgug;->h:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v0, Lgug;->p:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v0, Lgug;->o:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v0, Lgug;->q:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v0, Lgug;->l:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v0, Lgug;->i:Landroid/animation/ValueAnimator;
    ...
    iget-object v3, v0, Lgug;->d:Lgvi;

    invoke-virtual {v3}, Lgvi;->i()Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iput-object v3, v2, Lgvj;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, Lgug;->j:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v0, Lgug;->k:Landroid/animation/ValueAnimator;
    ...
    iget-object v2, v0, Lgug;->m:Landroid/animation/ValueAnimator;
    ...
    sget-object v3, Lgue;->b:Lgue;

    invoke-virtual {v2, v3}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->resetTo(Lgue;)V
    ...
    iget-object v2, v0, Lgug;->n:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v3, v0}, Lguw;-><init>(Lgug;)V
...
.method private initialize()V
    ...
    invoke-direct {v1, p0}, Lguc;-><init>(Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;)V

    invoke-direct {v0, v1}, Lgvk;-><init>(Landroid/view/GestureDetector$SimpleOnGestureListener;)V

    iput-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->gestureDetector:Lgvk;
    ...
    invoke-static {v0, v1}, Lgvi;->a(Lgue;Landroid/content/res/Resources;)Lgvi;

    move-result-object v0

    invoke-virtual {v0}, Lgvi;->q()Lgvj;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->currentSpec:Lgvj;
    ...
    invoke-direct {v0, p0}, Lguf;-><init>(Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->currentSpec:Lgvj;

    invoke-virtual {v0}, Lgvj;->b()Lgue;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->updateContentDescription(Lgue;)V

    return-void
.end method

.method private isVideoMode(Lgue;)Z
    .locals 1
    ...
    sget-object v0, Lgue;->j:Lgue;

    if-eq p1, v0, :cond_0

    sget-object v0, Lgue;->i:Lgue;

    if-eq p1, v0, :cond_0

    sget-object v0, Lgue;->k:Lgue;
...
.method private resetShutterButton()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->currentSpec:Lgvj;

    invoke-virtual {v1}, Lgvj;->b()Lgue;
...
.method private runEnableChangeAnimation(Z)V
    ...
    invoke-direct {v1, p0}, Lgua;-><init>(Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;)V
...
.method private updateContentDescription(Lgue;)V
    .locals 2
...
.method public animateToScale(F)V
    ...
    invoke-direct {v1, p0}, Lgub;-><init>(Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;)V
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->gestureDetector:Lgvk;

    iget-object v3, v0, Lgvk;->a:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, v0, Lgvk;->f:Landroid/view/MotionEvent;

    if-eqz v4, :cond_3

    iget-object v4, v0, Lgvk;->d:Landroid/os/Handler;

    iget-object v5, v0, Lgvk;->g:Ljava/lang/Runnable;
    ...
    iput-object v4, v0, Lgvk;->f:Landroid/view/MotionEvent;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lhjv;-><init>(FFFF)V

    iput-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->touchCoordinate$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFCDGMQPBIC4NNAQBLEHKMOSPFAHNNAOR88DNMUSJ4D5N62T357C______0:Lhjv;
...
.method protected drawableStateChanged()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->listener:Lgvg;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->listener:Lgvg;

    invoke-interface {v1, v0}, Lgvg;->onShutterButtonPressedStateChanged(Z)V
...
.method public getClickEnabledObservable()Lick;
    .locals 1

    iget-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->filteredClickEnabledObservable:Lick;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, v1, Lgvj;->a:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object v1, v1, Lgvj;->a:Ljava/lang/Integer;
    ...
    iget-object v2, v1, Lgvj;->e:Ljava/lang/Integer;
    ...
    :cond_1
    iget-object v1, v1, Lgvj;->e:Ljava/lang/Integer;
    ...
    iget-object v2, v1, Lgvj;->b:Ljava/lang/Integer;
    ...
    :cond_2
    iget-object v1, v1, Lgvj;->b:Ljava/lang/Integer;
    ...
    iget-object v2, v1, Lgvj;->g:Ljava/lang/Integer;
    ...
    :cond_3
    iget-object v1, v1, Lgvj;->g:Ljava/lang/Integer;
    ...
    :cond_5
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->onDrawListener:Lgud;

    if-eqz v0, :cond_9

    iget-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->onDrawListener:Lgud;

    iget-object v0, v0, Lgud;->a:Lbzb;

    iget-object v0, v0, Lbzb;->i:Lcom/google/android/apps/camera/stats/CameraActivitySession;
    ...
    iget-object v2, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->currentSpec:Lgvj;

    invoke-virtual {v2}, Lgvj;->j()I
    ...
    invoke-virtual {v0}, Lgvj;->h()I

    move-result v0

    iget-object v1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->currentSpec:Lgvj;

    invoke-virtual {v1}, Lgvj;->c()I
    ...
    iget-object v1, v0, Lgvj;->d:Ljava/lang/Boolean;
    ...
    :cond_d
    iget-object v0, v0, Lgvj;->d:Ljava/lang/Boolean;
    ...
    iget-object v3, v2, Lgvj;->f:Ljava/lang/Integer;
    ...
    :cond_e
    iget-object v2, v2, Lgvj;->f:Ljava/lang/Integer;
    ...
    invoke-direct {p0, v0}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->isVideoMode(Lgue;)Z
    ...
    iget-object v0, v0, Lgvj;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->currentSpec:Lgvj;

    invoke-virtual {v3}, Lgvj;->i()I
    ...
    iget-object v4, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->currentSpec:Lgvj;

    invoke-virtual {v4}, Lgvj;->i()I
    ...
    iget-object v5, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->currentSpec:Lgvj;

    invoke-virtual {v5}, Lgvj;->i()I
...
.method public performClick()Z
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->touchCoordinate$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFCDGMQPBIC4NNAQBLEHKMOSPFAHNNAOR88DNMUSJ4D5N62T357C______0:Lhjv;

    if-eqz v1, :cond_2

    iget-object v1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->listener:Lgvg;

    iget-object v2, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->touchCoordinate$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFCDGMQPBIC4NNAQBLEHKMOSPFAHNNAOR88DNMUSJ4D5N62T357C______0:Lhjv;

    invoke-interface {v1, v2}, Lgvg;->onShutterTouch$51666RRD5TJMURR7DHIIUOBECHP6UQB45TGN0S3J5THM2RB5E9GIUTB9ELQ6IR3J5TA6UTB3D11MURRICHKMSOBKCKTIILG_0(Lhjv;)V

    :cond_2
    const/4 v1, 0x0

    iput-object v1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->touchCoordinate$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFCDGMQPBIC4NNAQBLEHKMOSPFAHNNAOR88DNMUSJ4D5N62T357C______0:Lhjv;

    iget-object v1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->listener:Lgvg;

    invoke-interface {v1}, Lgvg;->onShutterButtonClick()V
...
.method public removeListener()V
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->listener:Lgvg;

    return-void
.end method

.method public resetTo(Lgue;)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->currentSpec:Lgvj;

    invoke-virtual {v0, p1}, Lgvj;->a(Lgue;)Lgvj;
...
.method public runPressedStateAnimation(ZLgug;)V
    .locals 3
    ...
    invoke-virtual {p0}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->getClickEnabledObservable()Lick;
    ...
    invoke-virtual {p2, v0, v1}, Lgug;->a(FI)Landroid/view/ViewPropertyAnimator;
    ...
    invoke-virtual {p0, v0, p2}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->setMode(Lgue;Lgug;)V
...
.method public setListener(Lgvg;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->listener:Lgvg;
...
.method public setMode(Lgue;Lgug;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->animateMainButton(Lgue;Lgug;)V
    ...
    invoke-virtual {p1}, Lgue;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->setTag(Ljava/lang/Object;)V

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->updateContentDescription(Lgue;)V

    goto/16 :goto_0
.end method

.method public setOnDrawListener(Lgud;)V
    .locals 2
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/ui/shutterbutton/ShutterButton;->onDrawListener:Lgud;
