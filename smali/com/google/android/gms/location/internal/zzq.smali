...
.method public constructor <init>(ILcom/google/android/gms/location/internal/zzo;Landroid/os/IBinder;Landroid/app/PendingIntent;Landroid/os/IBinder;Landroid/os/IBinder;)V
    ...
    :goto_0
    iput-object v0, p0, Lcom/google/android/gms/location/internal/zzq;->c:Lhwe;
    ...
    :goto_1
    iput-object v0, p0, Lcom/google/android/gms/location/internal/zzq;->e:Lhwb;

    if-nez p6, :cond_7

    :cond_0
    :goto_2
    iput-object v1, p0, Lcom/google/android/gms/location/internal/zzq;->f:Lhvp;
    ...
    invoke-direct {v0, p3}, Lhwg;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v0, p5}, Lhwd;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, p6}, Lhvr;-><init>(Landroid/os/IBinder;)V

    goto :goto_2
.end method

.method public static a(Lhwe;Lhvp;)Lcom/google/android/gms/location/internal/zzq;
    .locals 7
    ...
    invoke-interface {p0}, Lhwe;->asBinder()Landroid/os/IBinder;

    move-result-object v3

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lhvp;->asBinder()Landroid/os/IBinder;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {p1, v0, v3}, Lhmr;->c(Landroid/os/Parcel;II)V

    const/4 v0, 0x2

    iget-object v3, p0, Lcom/google/android/gms/location/internal/zzq;->b:Lcom/google/android/gms/location/internal/zzo;

    invoke-static {p1, v0, v3, p2}, Lhmr;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    const/4 v3, 0x3

    iget-object v0, p0, Lcom/google/android/gms/location/internal/zzq;->c:Lhwe;
    ...
    :goto_0
    invoke-static {p1, v3, v0}, Lhmr;->a(Landroid/os/Parcel;ILandroid/os/IBinder;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/internal/zzq;->e:Lhwb;
    ...
    iget-object v3, p0, Lcom/google/android/gms/location/internal/zzq;->f:Lhvp;

    if-nez v3, :cond_2

    :goto_2
    invoke-static {p1, v0, v1}, Lhmr;->a(Landroid/os/Parcel;ILandroid/os/IBinder;)V
    ...
    invoke-interface {v0}, Lhwe;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {v0}, Lhwb;->asBinder()Landroid/os/IBinder;
    ...
    :cond_2
    iget-object v1, p0, Lcom/google/android/gms/location/internal/zzq;->f:Lhvp;

    invoke-interface {v1}, Lhvp;->asBinder()Landroid/os/IBinder;
