...
# direct methods
.method public constructor <init>(Ljava/lang/String;I[Liyv;Ljnq;Ljjz;)V
    .locals 0
    ...
    iput-object p3, p0, Lizv;->d:[Liyv;

    iput-object p4, p0, Lizv;->c:Ljnq;

    iput-object p5, p0, Lizv;->e:Ljjz;
...
.method public final a(Ljkl;Ljava/util/concurrent/Executor;)Liqz;
    ...
    invoke-virtual/range {p1 .. p1}, Ljkl;->a()I
    ...
    iget-object v4, v0, Lizv;->c:Ljnq;

    invoke-virtual/range {p1 .. p1}, Ljkl;->b()J

    move-result-wide v6

    invoke-virtual {v4, v6, v7}, Ljnq;->a(J)Ljne;

    move-result-object v4

    sget-object v5, Ljne;->b:Ljnm;

    invoke-virtual {v4, v5}, Ljne;->a(Ljnm;)Ljava/lang/Object;
    ...
    iget-object v4, v0, Lizv;->e:Ljjz;

    invoke-interface {v4, v8, v9}, Ljjz;->a(J)Ljpj;
    ...
    new-instance v8, Lizx;

    invoke-direct {v8, v4, v6}, Lizx;-><init>(FI)V
    ...
    iget-object v5, v13, Liyv;->f:Ljava/util/List;
    ...
    iget-object v5, v13, Liyv;->d:Liyw;

    if-ne v5, v12, :cond_7

    iget-object v5, v13, Liyv;->e:Ljava/util/List;
    ...
    iget-object v4, v13, Liyv;->f:Ljava/util/List;
    ...
    iget-object v6, v13, Liyv;->f:Ljava/util/List;
    ...
    iget-object v5, v0, Lizv;->c:Ljnq;

    invoke-virtual {v5, v6, v7}, Ljnq;->a(J)Ljne;

    move-result-object v5

    sget-object v28, Ljne;->p:Ljnm;

    move-object/from16 v0, v28

    invoke-virtual {v5, v0}, Ljne;->b(Ljnm;)Z
    ...
    sget-object v9, Ljne;->p:Ljnm;

    invoke-virtual {v5, v9}, Ljne;->a(Ljnm;)Ljava/lang/Object;
    ...
    iget-object v5, v0, Lizv;->a:Ljava/lang/String;
    ...
    iget v9, v13, Liyv;->c:I

    int-to-float v9, v9

    add-float/2addr v5, v9

    iget v9, v13, Liyv;->a:I
    ...
    invoke-direct/range {v4 .. v9}, Ljaq;-><init>(Liyx;JLandroid/graphics/RectF;Landroid/graphics/RectF;)V
    ...
    :cond_17
    new-instance v7, Lizw;

    invoke-direct {v7, v4, v5}, Lizw;-><init>(Liyv;Ljava/util/List;)V

    new-instance v5, Lizr;

    iget-object v6, v7, Lizw;->a:Liyv;

    iget-object v7, v7, Lizw;->b:Ljava/util/List;

    move-object/from16 v0, p0

    iget-object v8, v0, Lizv;->a:Ljava/lang/String;

    move-object/from16 v0, p0

    iget v9, v0, Lizv;->b:I

    invoke-virtual/range {p1 .. p1}, Ljkl;->c()J

    move-result-wide v10

    invoke-direct/range {v5 .. v11}, Lizr;-><init>(Liyv;Ljava/util/List;Ljava/lang/String;IJ)V

    invoke-static {v5}, Lihr;->b(Ljava/lang/Object;)Liqz;
